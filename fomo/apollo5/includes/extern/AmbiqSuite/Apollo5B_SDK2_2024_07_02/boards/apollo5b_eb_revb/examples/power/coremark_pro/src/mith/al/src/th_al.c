...
#define GETMYTIME(_t) (*_t = g_ui32SysTickWrappedTime)
/* setting to 1/1000 of a second resolution by default with linux */
#ifndef TIMER_RES_DIVIDER
  #define TIMER_RES_DIVIDER (MY_CORECLK_HZ / 1000)
#endif
...
{
    g_ui32SysTickWrappedTime = 0;
    am_hal_systick_init(AM_HAL_SYSTICK_CLKSRC_INT);
    am_hal_systick_load(MY_CORECLK_HZ/1000);
