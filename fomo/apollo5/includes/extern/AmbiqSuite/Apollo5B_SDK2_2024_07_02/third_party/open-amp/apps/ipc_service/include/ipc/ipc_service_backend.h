...
#ifndef IPC_SERVICE_IPC_SERVICE_BACKEND_H_
#define IPC_SERVICE_IPC_SERVICE_BACKEND_H_
...
extern "C"
{
    ...
    {
        /** @brief Pointer to the function that will be used to send data to the
         *endpoint.
         *
         ...
         *	    backend.
         */
        int (*send)(const struct ipc_device *instance, void *token,
                    const void *data, size_t len);

        /** @brief Pointer to the function that will be used to register
         *endpoints.
         *
         ...
         *
         *  @retval -EINVAL when the endpoint configuration or instance is
         *invalid.
         *  @retval -EBUSY when the instance is busy or not ready.
         *
         *  @retval 0 on success
         ...
         *	    backend.
         */
        int (*register_endpoint)(const struct ipc_device *instance,
                                 void **token, const struct ipc_ept_cfg *cfg);
         ...
         *	    backend.
         */
        int (*get_tx_buffer_size)(const struct ipc_device *instance,
                                  void                    *token);
         ...
         *	    backend.
         */
        int (*get_tx_buffer)(const struct ipc_device *instance, void *token,
                             void **data, uint32_t *len, int wait);
         ...
         *	    backend.
         */
        int (*drop_tx_buffer)(const struct ipc_device *instance, void *token,
                              const void *data);
         ...
         *	    backend.
         */
        int (*send_nocopy)(const struct ipc_device *instance, void *token,
                           const void *data, size_t len);
         ...
         *	    backend.
         */
        int (*hold_rx_buffer)(const struct ipc_device *instance, void *token,
                              void *data);
         ...
         *	    backend.
         */
        int (*release_rx_buffer)(const struct ipc_device *instance, void *token,
                                 void *data);
    };
...
#endif /* IPC_SERVICE_IPC_SERVICE_BACKEND_H_ */
