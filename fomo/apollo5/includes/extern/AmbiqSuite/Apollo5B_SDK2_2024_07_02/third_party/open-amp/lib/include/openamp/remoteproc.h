...
#include "../../../libmetal/lib/mutex.h"
#include "../../../libmetal/lib/compiler.h"
...
/**
 * remoteproc_load_section
 *
 * load section, it expects the user application defines how to
 * open the executable file and how to get data from the executable file
 * and how to load section to the target memory.
 *
 * @rproc: pointer to the remoteproc instance
 * @path: optional path to the image file
 * @store: pointer to user defined image store argument
 ...
 * @image_info: pointer to memory which stores image information used
 *              by remoteproc loader
 * @sect_name: pointer to section name whitch linkscript generates section
 * in the executable file
 * return 0 for success and negative value for failure
 */
int remoteproc_load_section(struct remoteproc *rproc, const char *path,
		    void *store, const struct image_store_ops *store_ops,
		    void **img_info, const char *sect_name);
