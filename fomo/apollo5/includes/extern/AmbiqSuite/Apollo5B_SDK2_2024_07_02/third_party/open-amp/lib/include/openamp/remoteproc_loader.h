...
#include "../../../libmetal/lib/metal_list.h"
...
struct loader_ops {
	...
	int (*load_data)(struct remoteproc *rproc,
			 ...
			 size_t *noffset, size_t *nlen,
			 unsigned char *padding, size_t *nmemsize, unsigned int *flag);
    int (*load_section)(void *elf_info, const char *name, metal_phys_addr_t *da,
