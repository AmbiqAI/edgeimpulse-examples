...
// #### INTERNAL BEGIN ####
//*****************************************************************
// Internal Debugging defines
//*****************************************************************
// Enable AM_HAL_USB_PHYREFCLK_FORCE_HRFC_24M below to use HFRC2_24MHz for USB
// PHYREFCLK
//#define AM_HAL_USB_PHYREFCLK_FORCE_HRFC_24M
#ifdef AM_HAL_USB_PHYREFCLK_FORCE_HRFC_24M
#define AM_HAL_USB_PHYREFCLK_FORCE_LLMUXSEL     AM_HAL_SYSPLL_LLMUX_USB_SRC_CLKGEN
#define AM_HAL_USB_PHYREFCLK_FORCE_CLKGENMUXSEL USB_CLKCTRL_PHYREFCLKSEL_HFRC_24MHz
#else
// Define both of the followings to force PHYREFCLK Mux selects
// #define AM_HAL_USB_PHYREFCLK_FORCE_LLMUXSEL     AM_HAL_SYSPLL_LLMUX_USB_SRC_PLL
// #define AM_HAL_USB_PHYREFCLK_FORCE_CLKGENMUXSEL USB_CLKCTRL_PHYREFCLKSEL_OFF
#endif
// #### INTERNAL END ####
...
//*****************************************************************************
//
//! Preemphasis enable state select enums
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
//! HS ODT resistance tuning enums
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
//! HS Squelch Trigger Point Tuning Enums
//
//*****************************************************************************
typedef enum
{
...
//*****************************************************************************
//
//! HS PHY Tuning value selected.
//
//*****************************************************************************
#define AM_HAL_USB_PHY_PREEMP_ENABLE_STATE              (AM_HAL_USB_PHY_PREEMP_ENABLE_STATE_SOF_EOP)
#define AM_HAL_USB_PHY_R_ODT_TUNE_VALUE                 (AM_HAL_USB_PHY_R_ODT_VAL_5)
#define AM_HAL_USB_PHY_HS_EYE_HEIGHT_TUNE_VALUE         (AM_HAL_USB_PHY_HS_EYE_HEIGHT_TUNE_0P5000V)
#define AM_HAL_USB_PHY_HS_SQUELCH_TUNE_VALUE            (AM_HAL_USB_PHY_HS_SQUELCH_TUNE_0P1500V)
                         ...
                         bool bRetainState)
{
    ...
    switch (ePowerState)
    {
        case AM_HAL_SYSCTRL_WAKE:
            ...
            //
            // Set Eye Height Tuning Value to USB PHY once USB powered up
            //
            USBPHY->REG00_b.BF20 = AM_HAL_USB_PHY_PREEMP_ENABLE_STATE;
            USBPHY->REG08_b.BF64 = AM_HAL_USB_PHY_HS_EYE_HEIGHT_TUNE_VALUE;
            USBPHY->REG08_b.BF30 = AM_HAL_USB_PHY_HS_SQUELCH_TUNE_VALUE;
            USBPHY->REG0C_b.BF62 = AM_HAL_USB_PHY_R_ODT_TUNE_VALUE;
            break;
...
am_hal_usb_phy_clock_enable(void *pHandle, bool bEnable, am_hal_usb_dev_speed_e eSpeed)
{
    ...
    {
        // #### INTERNAL BEGIN ####
        #if (defined(AM_HAL_USB_PHYREFCLK_FORCE_LLMUXSEL) && defined(AM_HAL_USB_PHYREFCLK_FORCE_CLKGENMUXSEL))
        eTargetLLMuxSel = AM_HAL_USB_PHYREFCLK_FORCE_LLMUXSEL;
        eTargetUsbClkGenSel = AM_HAL_USB_PHYREFCLK_FORCE_CLKGENMUXSEL;
        #else
        // #### INTERNAL END ####
    ...
    if (eCurLLMuxSel != eTargetLLMuxSel)
    {
        ...
        //
        // #### INTERNAL BEGIN ####
        // Wait for at least 2 clock cycle of the slower clock, which is
        // expected to be 24MHz for USB. which amounts to 41.67ns.
        // #### INTERNAL END ####
...
am_hal_usb_fifo_unloading_dma1(USB_Type *pUSB, am_hal_usb_state_t *pState, uint8_t ui8EpNum, uint8_t *pucBuf, uint32_t ui32Count)
{
    ...
    //
    pXfer->pLastBufAddr                 = (uint32_t)pucBuf;
    pXfer->pStartBufAddr                = (uint32_t)pucBuf;
