...
// #### INTERNAL END ####
            ...
            // #### INTERNAL BEGIN ####
            // This handling is done in accordance to the configuration verified
            // by Garmin in GAR-147 for XTAL_LS external clock mode.
            // However, according to the comments, the validation and
            //  characterization for this config is still pending.
            // #### INTERNAL END ####
            //
...
// #### INTERNAL END ####
        ...
        case AM_HAL_MCUCTRL_CONTROL_EXTCLK32M_CLKOUT_ENABLE:
            ...
            {
                // #### INTERNAL BEGIN ####
                // Check if the drive strength setting is valid. In COR-101 and CAYNSWS-2792,
                // Design/Arch have not decided to open drive strength descriptions to
                // customer, so I used magic numbers here.
                // #### INTERNAL END ####
