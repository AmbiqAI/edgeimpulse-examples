...
// expected to be 24.576MHz for AUDADC. which amounts to 40.69ns.
// #### INTERNAL END ####
...
audadc_clock_set(uint32_t ui32Module, am_hal_audadc_clksel_e targetClk)
{
    ...
    else
    {
        ...
        else if (LLMuxStatus == MCUCTRL_PLLMUXCTL_AUDADCPLLCLKSEL_PLL)
        {
            ...
            {
                // #### INTERNAL BEGIN ####
                // Note that "targetClkgen" can't be AUDADC_CFG_CLKSEL_OFF, otherwise LL mux switching will fail.
                // #### INTERNAL END ####
                        ...
                        am_hal_audadc_config_t *psConfig)
{
    ...
    {
// #### INTERNAL BEGIN ####
        #warning Please recalculate this value
// #### INTERNAL END ####
        g_AUDADCSlotTrkCycMin = 19;
    }
                                       ...
                                       am_hal_offset_cal_coeffs_array_t *pSlotCalib)
{
    ...
    for (ui32SlotNumber = 0; ui32SlotNumber < ui32SlotTotalNumber; ui32SlotNumber++)
    {
        ...
        // #### INTERNAL BEGIN ####
        // CAYNSWS-1931 1/30/24
        // INFO1_ADC_xxx trims: Apollo5a BGA did not trim, 5a CSP and 5b trimmed.
        // INFO1 AUDADC  trims: Apollo5a did not trim these, may eventually trim on Apollo5b.
        // #### INTERNAL END ####
