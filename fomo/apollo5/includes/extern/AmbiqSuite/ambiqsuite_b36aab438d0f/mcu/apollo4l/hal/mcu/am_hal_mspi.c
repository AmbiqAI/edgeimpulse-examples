...
#if 0
            //
            // Remove two dummy transactions from MSPI CQ. Need to retest on Apollo4Lite silicon.
            //
...
#warning TODO FIXME: - Need to wait for all XIPMM transactions to flush out of Apollo4x MSPI.
// #### INTERNAL END ####
    }
    //
    // Return the status.
...
// #### INTERNAL BEGIN ####
            ...
            //
//            ui32Config |= _VAL2FLD(MSPI0_DEV0XIPMISC_AFIFOLVL0, 0x10); //AFIFOLVL bit is removed from Apollo4l.

            //
            // Set the XIPBOUNDARY bit.
            //
//            ui32Config |= _VAL2FLD(MSPI0_DEV0XIPMISC_XIPBOUNDARY0, pXipMisc->bXIPBoundary); //XIPBOUNDARY bit is removed from Apollo4l
// #### INTERNAL END ####
