...
// #### INTERNAL BEGIN ####
#if 0  // PWRCTRL PWRWEIGHTS is removed from Apollo4-Lite
    //
...
// #### INTERNAL BEGIN ####
// Original issue in apollo4 RevB
...
//
// TBIRDSW-416 - Still needed in apollo4 Lite as issues arise with ITM if not in code.
// #### INTERNAL END ####
    //
...
// #### INTERNAL BEGIN ####
        ...
        //       clears up the VDDC dip when the device switches from SIMOBUCK to LDO.
        //       XSP-252
        //
// #### INTERNAL END ####
        //
...
// #### INTERNAL BEGIN ####
#if AM_HAL_PWRCTRL_VDDC_REDUCE_ENABLE || AM_HAL_PWRCTRL_VDDC_BOOST_FOR_GPU_ENABLE
            if ( ui32TrimVer < TRIMREV_PCM )
            {
                // Set the AI_KEY
                AM_REGVAL(0x400401FC) = 0x61EBBE3C;
                AM_REGVAL(0x400400F8) = 0xAA16A508;
                AM_REGVAL(0x40040144) = 0x5C13A663;
                AM_REGVAL(0x40040278) = 0x49B43703;
