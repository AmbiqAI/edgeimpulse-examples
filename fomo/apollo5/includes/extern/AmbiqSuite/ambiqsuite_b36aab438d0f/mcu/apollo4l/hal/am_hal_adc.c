...
// #### INTERNAL BEGIN ####
//
// ERR090 is no longer needed since the GPADC was characterized and all values
// have been updated in the HAL.
//
// FSV-1160 GPADC Characterization for New Settings to Fix Missed-First Sample
// and slow LPMODE1
//
//*****************************************************************************
//
...
// #### INTERNAL END ####
            if ( bRetainState )
            {
                ...
                // #### INTERNAL BEGIN ####
                //
                // A2SD-2412 and COR-100
                // ADCEN bit can't be written along with TRIGSEL bits, so restore the
                //  CFG register with two APB writes.
                //
                // #### INTERNAL END ####
