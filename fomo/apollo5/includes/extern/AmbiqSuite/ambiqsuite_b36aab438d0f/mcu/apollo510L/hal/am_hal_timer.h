...
typedef enum
{
    ...
    AM_HAL_TIMER_CLOCK_PLL_250M     = TIMER_CTRL0_TMR0CLK_PLLVCO_250MHz,
    AM_HAL_TIMER_CLOCK_PLL_POSTDIV  = TIMER_CTRL0_TMR0CLK_PLLVCO_POSTDIV,
    AM_HAL_TIMER_CLOCK_PLL_FOUT2    = TIMER_CTRL0_TMR0CLK_PLLVCO_FOUT2,
    AM_HAL_TIMER_CLOCK_PLL_FOUT3    = TIMER_CTRL0_TMR0CLK_PLLVCO_FOUT3,
    AM_HAL_TIMER_CLOCK_PLL_FOUT4    = TIMER_CTRL0_TMR0CLK_PLLVCO_FOUT4,
