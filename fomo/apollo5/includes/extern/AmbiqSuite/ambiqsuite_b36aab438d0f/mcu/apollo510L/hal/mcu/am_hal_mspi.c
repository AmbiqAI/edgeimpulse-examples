    ...
    if ( pConfig->bNewDDR )
    {
        ...
        switch ( pConfig->eClockFreq )
        {
            case AM_HAL_MSPI_CLK_250MHZ:
                CLKGEN->MSPIIOCLKCTRL |= ((uint32_t)AM_HAL_MSPI_IO_CLK_PLLVCO_250MHZ << CLKGEN_MSPIIOCLKCTRL_MSPI0IOCLKSEL_Pos) << ui32Module * CLKGEN_MSPIIOCLKCTRL_MSPI1IOCLKEN_Pos;
                break;
            case AM_HAL_MSPI_CLK_125MHZ:
                CLKGEN->MSPIIOCLKCTRL |= ((uint32_t)AM_HAL_MSPI_IO_CLK_PLLVCO_125MHZ << CLKGEN_MSPIIOCLKCTRL_MSPI0IOCLKSEL_Pos) << ui32Module * CLKGEN_MSPIIOCLKCTRL_MSPI1IOCLKEN_Pos;
                break;
    ...
    else
    {
        ...
        switch ( pConfig->eClockFreq )
        {
            ...
            case AM_HAL_MSPI_CLK_3P91MHZ:
                ...
                {
                    case 0:
                        CLKGEN->MSPIIOCLKCTRL_b.MSPI0IOCLKSEL = AM_HAL_MSPI_IO_CLK_PLLVCO_250MHZ;
                        break;
                    case 1:
                        CLKGEN->MSPIIOCLKCTRL_b.MSPI1IOCLKSEL = AM_HAL_MSPI_IO_CLK_PLLVCO_250MHZ;
                        break;
                    case 2:
                        CLKGEN->MSPIIOCLKCTRL_b.MSPI2IOCLKSEL = AM_HAL_MSPI_IO_CLK_PLLVCO_250MHZ;
                        break;
                    default:
                        return AM_HAL_STATUS_OUT_OF_RANGE;
                }
            ...
            case AM_HAL_MSPI_CLK_1P5MHZ:
                ...
                {
                    case 0:
                        CLKGEN->MSPIIOCLKCTRL_b.MSPI0IOCLKSEL = AM_HAL_MSPI_IO_CLK_HFRC_96MHZ;
                        break;
                    case 1:
                        CLKGEN->MSPIIOCLKCTRL_b.MSPI1IOCLKSEL = AM_HAL_MSPI_IO_CLK_HFRC_96MHZ;
                        break;
                    case 2:
                        CLKGEN->MSPIIOCLKCTRL_b.MSPI2IOCLKSEL = AM_HAL_MSPI_IO_CLK_HFRC_96MHZ;
                        break;
                    default:
                        return AM_HAL_STATUS_OUT_OF_RANGE;
                }
