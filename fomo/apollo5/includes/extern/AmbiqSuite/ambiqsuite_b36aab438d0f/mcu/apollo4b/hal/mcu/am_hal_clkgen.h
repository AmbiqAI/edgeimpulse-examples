...
// #### INTERNAL BEGIN ####
// the XTAL24MCTRL register was removed from the Falcon design
...
// #### INTERNAL BEGIN ####
#if 0   // The CLKOUT HFRC register enums for revB are out-of-sync and
        // must first be fixed in the register definitions.
        // In the meantime, we'll hard-code the correct values.
