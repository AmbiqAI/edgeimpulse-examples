                             ...
                             const am_hal_mspi_dev_config_t *pConfig)
{
    ...
    switch ( pConfig->eClockFreq )
    {
        case AM_HAL_MSPI_CLK_96MHZ:
            // #### INTERNAL BEGIN ####
            //
            // RXCAP0 does not apply to 96MHz.
            // HSP20-447:
            // https://ambiqmicrosupport.atlassian.net/browse/HSP20-447?focusedCommentId=31477
            //
            // #### INTERNAL END ####
...
// #### INTERNAL END ####
    ...
    //
// #### INTERNAL BEGIN ####
#warning "TODO FIXME: Need to evaluate interaction with highprio transactions - for now restricting it"
// #### INTERNAL END ####
    if (pMSPIState->ui32NumCQEntries || pMSPIState->ui32NumHPEntries)
    {
        return AM_HAL_STATUS_IN_USE;
...
// #### INTERNAL BEGIN ####
#warning TODO FIXME: - This should not be needed for Apollo4.
#if 0
    // This is the SW check to prevent CORVETTE-1174. DMA is not allowed to/from DTCM.
    //
    // Check for DMA to/from DTCM.
