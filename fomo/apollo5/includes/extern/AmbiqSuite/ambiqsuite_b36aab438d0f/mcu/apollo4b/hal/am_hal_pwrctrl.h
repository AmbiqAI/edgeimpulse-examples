...
// Enabling it may provide wider passing window for PSRAM XIP when HP mode is used
// #### INTERNAL END ####
//*****************************************************************************
...
//
// #### INTERNAL BEGIN ####
// 2/10/22 Per FSV-992 and email, the recommendation is that this option now
// default to 0 as FSV-870 is covered by by the FB-164 and A2SD-2248 workarounds.
//
// This needs to be default for B2++ as per Jamie as of 9/29/2021 (FSV-870).
// #### INTERNAL END ####
//*****************************************************************************
