...
//
//*****************************************************************************
#define AM_HAL_DEVICE_NAME      "Apollo5a"
...
//*****************************************************************************
//
//! Since am_hal_debug is not implemented for revA, simply define the
//! function names to return success.
//
//*****************************************************************************
#define am_hal_debug_enable()           AM_HAL_STATUS_SUCCESS
#define am_hal_debug_disable()          AM_HAL_STATUS_SUCCESS
#define am_hal_debug_power(bPowerup)    AM_HAL_STATUS_SUCCESS
#define am_hal_debug_trace_enable()     AM_HAL_STATUS_SUCCESS
#define am_hal_debug_trace_disable()    AM_HAL_STATUS_SUCCESS
