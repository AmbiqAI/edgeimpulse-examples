...
//*****************************************************************************
//
//! @brief Implements deepsleep entry workaround for SWO pads if ITM is enabled
//!
//! @param None
//!
//! This function Checks for any pads configured for SWO function if ITM is enabled.
//! If so - it implements a workaround to avoid SWO going low during deepsleep
//! This function should always be called before entering deepsleep, and
//! paired with am_hal_itm_handle_deepsleep_exit
//
//*****************************************************************************
extern void am_hal_itm_handle_deepsleep_enter(void);

//*****************************************************************************
//
//! @brief Implements deepsleep exit workaround for SWO pads if ITM is enabled
//!
//! @param None
//!
//! This function reverts the workaround invoked in am_hal_itm_handle_deepsleep_enter
//! This function should always be called paired with am_hal_itm_handle_deepsleep_enter
//! after waking up from deepsleep
//
//*****************************************************************************
extern void am_hal_itm_handle_deepsleep_exit(void);
