...
typedef enum
{
    AM_HAL_AUDADC_CLKSEL_HFRC_48MHz           = 0,
    AM_HAL_AUDADC_CLKSEL_HFRC_48MHz_INV       = 1,   // HFRC 48M gated invert
    AM_HAL_AUDADC_CLKSEL_XTHS_32MHz           = 2,
    AM_HAL_AUDADC_CLKSEL_HFRC2_APPROX_31MHz   = 3,   // HFRC2_125M / 4 = 31.25MHz
    AM_HAL_AUDADC_CLKSEL_EXTREF_CLK           = 4    // External clock from AM_HAL_PIN_15_REFCLK_EXT
