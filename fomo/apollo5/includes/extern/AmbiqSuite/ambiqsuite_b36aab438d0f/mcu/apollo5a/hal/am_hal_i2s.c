...
am_hal_i2s_configure(void *pHandle, am_hal_i2s_config_t *psConfig)
{
    ...
    uint32_t ui32Fsel    = (bUseNcoClock ? 0 : psConfig->eClock) & AM_HAL_I2S_CLKSEL_REGISTER_BIT_MASK;
    uint32_t ui32RefFsel = (bUseNcoClock ? psConfig->eClock : 0) & AM_HAL_I2S_CLKSEL_REGISTER_BIT_MASK;
