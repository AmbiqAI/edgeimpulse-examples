...
// #### INTERNAL BEGIN ####
    ...
    //
    if ( AM_BFR(CLKGEN, OCTRL, STOPXT) == 1 )
    {
        //
        // Enable the XTAL.
        //
    ...
    if ( AM_BFR(CLKGEN, HFADJ, HFADJEN) == 0 )
    {
...
am_hal_itm_disable(void)
{
    ...
    // - At a minimum, in lieu of the above busy loop, am_hal_itm_not_busy(),
    //   which already incorporates a 50us delay, should be called instead.
    //   am_hal_itm_not_busy() which already incorporates a 50us delay.
