...
//*****************************************************************************
// ##### INTERNAL BEGIN ######
#define AM_HAL_IOM_24MHZ                                                      \
    (AM_REG_IOMSTR_CLKCFG_FSEL(1))

#define AM_HAL_IOM_12MHZ                                                      \
    (AM_REG_IOMSTR_CLKCFG_FSEL(2))
// ##### INTERNAL END ######
...
extern void     am_hal_iom_operate(uint32_t ui32Module, am_hal_iom_oper_t *pOper);
//##### INTERNAL END #####
