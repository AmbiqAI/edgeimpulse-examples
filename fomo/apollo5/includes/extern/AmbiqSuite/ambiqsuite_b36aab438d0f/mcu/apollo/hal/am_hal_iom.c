    ...
    if ( pOper->proto == AM_HAL_IOM_PROTO_SPI )
    {
        switch ( pOper->mode )
        {
            case AM_HAL_IOM_MODE_POLL:
                ...
                {
                    am_hal_iom_spi_write_nq(ui32Module, pOper->peerInfo.ui32ChipSelect,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options);
                }
                else
                {
                    am_hal_iom_spi_read_nq(ui32Module, pOper->peerInfo.ui32ChipSelect,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options);
                }
                if ( pOper->pfnCallback )
                {
                    pOper->pfnCallback();
                }
                break;
            case AM_HAL_IOM_MODE_NB:
                if ( pOper->oper == AM_HAL_IOM_OPER_WRITE )
                {
                    am_hal_iom_spi_write_nb(ui32Module, pOper->peerInfo.ui32ChipSelect,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                else
                {
                    am_hal_iom_spi_read_nb(ui32Module, pOper->peerInfo.ui32ChipSelect,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                break;
            case AM_HAL_IOM_MODE_QUEUE:
                if ( pOper->oper == AM_HAL_IOM_OPER_WRITE )
                {
                    am_hal_iom_queue_spi_write(ui32Module, pOper->peerInfo.ui32ChipSelect,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                else
                {
                    am_hal_iom_queue_spi_read(ui32Module, pOper->peerInfo.ui32ChipSelect,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                break;
    ...
    else if ( pOper->proto == AM_HAL_IOM_PROTO_I2C )
    {
        switch ( pOper->mode )
        {
            case AM_HAL_IOM_MODE_POLL:
                if ( pOper->oper == AM_HAL_IOM_OPER_WRITE )
                {
                    am_hal_iom_i2c_write_nq(ui32Module, pOper->peerInfo.ui32BusAddress,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options);
                }
                else
                {
                    am_hal_iom_i2c_read_nq(ui32Module, pOper->peerInfo.ui32BusAddress,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options);
                }
                if ( pOper->pfnCallback )
            ...
            case AM_HAL_IOM_MODE_NB:
                if ( pOper->oper == AM_HAL_IOM_OPER_WRITE )
                {
                    am_hal_iom_i2c_write_nb(ui32Module, pOper->peerInfo.ui32BusAddress,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                else
                {
                    am_hal_iom_i2c_read_nb(ui32Module, pOper->peerInfo.ui32BusAddress,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                break;
            case AM_HAL_IOM_MODE_QUEUE:
                if ( pOper->oper == AM_HAL_IOM_OPER_WRITE )
                {
                    am_hal_iom_queue_i2c_write(ui32Module, pOper->peerInfo.ui32BusAddress,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                else
                {
                    am_hal_iom_queue_i2c_read(ui32Module, pOper->peerInfo.ui32BusAddress,
                        pOper->pui32Data, pOper->ui32NumBytes,
                        pOper->ui32Options, pOper->pfnCallback);
                }
                break;
