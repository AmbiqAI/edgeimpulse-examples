...
{
// #### INTERNAL BEGIN ####
// TODO: Look at AS-1258 Info0 unexpected erased in fixed code flow
//       May need to add fix in A2SD-2291
// #### INTERNAL END ####
...
//##### INTERNAL BEGIN #####
    ...
    //
    // Break the flash programming operation into 64 word bursts
    //
    while ( ui32NumWords )
    {
        ui32Xfer = ui32NumWords > 64 ? 64 : ui32NumWords;

        iReturn = g_am_hal_flash.flash_program_main( ui32Value,
                                                            pui32Src,
                                                            pui32Dst,
                                                            ui32Xfer);
        ...
        pui32Src += ui32Xfer;
        pui32Dst += ui32Xfer;
        ui32NumWords -= ui32Xfer;
    }

    //
    // If we've made it here, everything was okay.
    //
    return 0;
#endif
//##### INTERNAL END #####
...
//##### INTERNAL BEGIN #####
    ...
    while ( ui32NumWords )
    {
        ...
        iReturn = g_am_hal_flash.flash_program_info( ui32Value,
                                                     ui32InfoInst,
                                                     pui32Src,
                                                     ui32Offset,
                                                     ui32Xfer);
