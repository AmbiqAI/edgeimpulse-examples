...
// #### INTERNAL BEGIN ####
#if APOLLO3P_FPGA
    // Fix up some fields for the Stingray FPGA.
    psDevice->ui32ChipPN  &= ~(MCUCTRL_CHIPPN_PARTNUM_FLASHSIZE_M | MCUCTRL_CHIPPN_PARTNUM_SRAMSIZE_M);
    psDevice->ui32ChipPN  |= (7 << MCUCTRL_CHIPPN_PARTNUM_FLASHSIZE_S)  |
                             (8 << MCUCTRL_CHIPPN_PARTNUM_SRAMSIZE_S);
#endif // APOLLO3P_FPGA
// #### INTERNAL END ####
