...
//
#if 1 // TODO 12/10/22 Mason to review and remove the #else, which was apparently
      //               put in to get building with the "design" version of usb_regs.src.
#define FRAME_NUM(pUSB)                        (pUSB->CFG3 & USB_CFG3_FRMNUM_Msk) >> USB_CFG3_FRMNUM_Pos
#else
#define FRAME_NUM(pUSB)                        (pUSB->CFG3 & USB_CFG3_FRAME_Msk) >> USB_CFG3_FRAME_Pos //FIXME
#endif
