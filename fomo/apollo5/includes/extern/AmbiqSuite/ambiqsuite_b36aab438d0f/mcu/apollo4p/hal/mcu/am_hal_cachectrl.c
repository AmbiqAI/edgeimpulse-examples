...
// #### INTERNAL BEGIN ####
    //
    // (9/8/2023) DL: This code has been altered per XSP-288. The poll for
    // DAXIREADY is moved to immediately after the flush command and APB sync.
    //
...
{
// #### INTERNAL BEGIN ####
#warning "TODO FIXME: Need to see if there are other special considerations/restrictions when changing DAXI settings"
// #### INTERNAL END ####
    AM_CRITICAL_BEGIN
