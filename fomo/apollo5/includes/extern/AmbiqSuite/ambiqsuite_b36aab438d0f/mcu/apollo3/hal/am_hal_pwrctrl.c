...
// #### INTERNAL BEGIN ####
    //
    // TODO:
    // A2SD-1438 As of 9/14/20 awaiting confirmation of the final settings. For now stay with old settings.
    //
...
// #### INTERNAL BEGIN ####
    ...
    //
    // Adjust the SIMOBUCK LP settings.
    // #### I N T E R N AL  B E G I N ####
    // A2SD-1438
    // #### I N T E R N A L   E N D ####
    //
    if ( APOLLO3_GE_B0 )
    {
...
// #### INTERNAL END ####
    ...
    // #### INTERNAL BEGIN ####
    // A2SD-1378 Update timeout to prevent brownouts.
    // #### INTERNAL END ####
    //
    if ( APOLLO3_GE_A1 )
    {
