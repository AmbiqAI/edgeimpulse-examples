...
// #### INTERNAL BEGIN ####
const am_hal_iom_regs_t g_IomRegs[AM_REG_IOM_NUM_MODULES] =
{
    {
        .pRegFIFO        = (volatile uint32_t *)(&IOM0->FIFO),
        .pRegFIFOPTR     = (volatile uint32_t *)(&IOM0->FIFOPTR),
        .pRegFIFOTHR     = (volatile uint32_t *)(&IOM0->FIFOTHR),
        .pRegFIFOPOP     = (volatile uint32_t *)(&IOM0->FIFOPOP),
        .pRegFIFOPUSH    = (volatile uint32_t *)(&IOM0->FIFOPUSH),
        .pRegFIFOCTRL    = (volatile uint32_t *)(&IOM0->FIFOCTRL),
        .pRegFIFOLOC     = (volatile uint32_t *)(&IOM0->FIFOLOC),
        .pRegCLKCFG      = (volatile uint32_t *)(&IOM0->CLKCFG),
        .pRegSUBMODCTRL  = (volatile uint32_t *)(&IOM0->SUBMODCTRL),
        .pRegCMD         = (volatile uint32_t *)(&IOM0->CMD),
        // CMDRPT register has been repurposed for DCX
        .pRegDCX         = (volatile uint32_t *)(&IOM0->DCX),
        .pRegOFFSETHI    = (volatile uint32_t *)(&IOM0->OFFSETHI),
        .pRegCMDSTAT     = (volatile uint32_t *)(&IOM0->CMDSTAT),
        .pRegDMATRIGEN   = (volatile uint32_t *)(&IOM0->DMATRIGEN),
        .pRegDMATRIGSTAT = (volatile uint32_t *)(&IOM0->DMATRIGSTAT),
        .pRegDMACFG      = (volatile uint32_t *)(&IOM0->DMACFG),
//Intrnl.pRegDMABCOUNT   = (volatile uint32_t *)(&IOM0->DMABCOUNT),
        .pRegDMATOTCOUNT = (volatile uint32_t *)(&IOM0->DMATOTCOUNT),
        .pRegDMATARGADDR = (volatile uint32_t *)(&IOM0->DMATARGADDR),
        .pRegDMASTAT     = (volatile uint32_t *)(&IOM0->DMASTAT),
        .pRegCQCFG       = (volatile uint32_t *)(&IOM0->CQCFG),
        .pRegCQADDR      = (volatile uint32_t *)(&IOM0->CQADDR),
        .pRegCQSTAT      = (volatile uint32_t *)(&IOM0->CQSTAT),
        .pRegCQFLAGS     = (volatile uint32_t *)(&IOM0->CQFLAGS),
        .pRegCQSETCLEAR  = (volatile uint32_t *)(&IOM0->CQSETCLEAR),
        .pRegCQPAUSEEN   = (volatile uint32_t *)(&IOM0->CQPAUSEEN),
        .pRegCQCURIDX    = (volatile uint32_t *)(&IOM0->CQCURIDX),
        .pRegCQENDIDX    = (volatile uint32_t *)(&IOM0->CQENDIDX),
        .pRegSTATUS      = (volatile uint32_t *)(&IOM0->STATUS),
        .pRegMSPICFG     = (volatile uint32_t *)(&IOM0->MSPICFG),
        .pRegMI2CCFG     = (volatile uint32_t *)(&IOM0->MI2CCFG),
        .pRegDEVCFG      = (volatile uint32_t *)(&IOM0->DEVCFG),
//Intrnl.pRegDBG0        = (volatile uint32_t *)(&IOM0->DBG0),
//Intrnl.pRegDBG1        = (volatile uint32_t *)(&IOM0->DBG1),
        .pRegIOMDBG      = (volatile uint32_t *)(&IOM0->IOMDBG),
        .pRegINTEN       = (volatile uint32_t *)(&IOM0->INTEN),
        .pRegINTSTAT     = (volatile uint32_t *)(&IOM0->INTSTAT),
        .pRegINTCLR      = (volatile uint32_t *)(&IOM0->INTCLR),
        .pRegINTSET      = (volatile uint32_t *)(&IOM0->INTSET),
    },
    {
        .pRegFIFO        = (volatile uint32_t *)(&IOM1->FIFO),
        .pRegFIFOPTR     = (volatile uint32_t *)(&IOM1->FIFOPTR),
        .pRegFIFOTHR     = (volatile uint32_t *)(&IOM1->FIFOTHR),
        .pRegFIFOPOP     = (volatile uint32_t *)(&IOM1->FIFOPOP),
        .pRegFIFOPUSH    = (volatile uint32_t *)(&IOM1->FIFOPUSH),
        .pRegFIFOCTRL    = (volatile uint32_t *)(&IOM1->FIFOCTRL),
        .pRegFIFOLOC     = (volatile uint32_t *)(&IOM1->FIFOLOC),
        .pRegCLKCFG      = (volatile uint32_t *)(&IOM1->CLKCFG),
        .pRegSUBMODCTRL  = (volatile uint32_t *)(&IOM1->SUBMODCTRL),
        .pRegCMD         = (volatile uint32_t *)(&IOM1->CMD),
        // CMDRPT register has been repurposed for DCX
        .pRegDCX         = (volatile uint32_t *)(&IOM1->DCX),
        .pRegOFFSETHI    = (volatile uint32_t *)(&IOM1->OFFSETHI),
        .pRegCMDSTAT     = (volatile uint32_t *)(&IOM1->CMDSTAT),
        .pRegDMATRIGEN   = (volatile uint32_t *)(&IOM1->DMATRIGEN),
        .pRegDMATRIGSTAT = (volatile uint32_t *)(&IOM1->DMATRIGSTAT),
        .pRegDMACFG      = (volatile uint32_t *)(&IOM1->DMACFG),
//Intrnl.pRegDMABCOUNT   = (volatile uint32_t *)(&IOM1->DMABCOUNT),
        .pRegDMATOTCOUNT = (volatile uint32_t *)(&IOM1->DMATOTCOUNT),
        .pRegDMATARGADDR = (volatile uint32_t *)(&IOM1->DMATARGADDR),
        .pRegDMASTAT     = (volatile uint32_t *)(&IOM1->DMASTAT),
        .pRegCQCFG       = (volatile uint32_t *)(&IOM1->CQCFG),
        .pRegCQADDR      = (volatile uint32_t *)(&IOM1->CQADDR),
        .pRegCQSTAT      = (volatile uint32_t *)(&IOM1->CQSTAT),
        .pRegCQFLAGS     = (volatile uint32_t *)(&IOM1->CQFLAGS),
        .pRegCQSETCLEAR  = (volatile uint32_t *)(&IOM1->CQSETCLEAR),
        .pRegCQPAUSEEN   = (volatile uint32_t *)(&IOM1->CQPAUSEEN),
        .pRegCQCURIDX    = (volatile uint32_t *)(&IOM1->CQCURIDX),
        .pRegCQENDIDX    = (volatile uint32_t *)(&IOM1->CQENDIDX),
        .pRegSTATUS      = (volatile uint32_t *)(&IOM1->STATUS),
        .pRegMSPICFG     = (volatile uint32_t *)(&IOM1->MSPICFG),
        .pRegMI2CCFG     = (volatile uint32_t *)(&IOM1->MI2CCFG),
        .pRegDEVCFG      = (volatile uint32_t *)(&IOM1->DEVCFG),
//Intrnl.pRegDBG0        = (volatile uint32_t *)(&IOM1->DBG0),
//Intrnl.pRegDBG1        = (volatile uint32_t *)(&IOM1->DBG1),
        .pRegIOMDBG      = (volatile uint32_t *)(&IOM1->IOMDBG),
        .pRegINTEN       = (volatile uint32_t *)(&IOM1->INTEN),
        .pRegINTSTAT     = (volatile uint32_t *)(&IOM1->INTSTAT),
        .pRegINTCLR      = (volatile uint32_t *)(&IOM1->INTCLR),
        .pRegINTSET      = (volatile uint32_t *)(&IOM1->INTSET),
    },
#if !APOLLO3_FPGA
    {
        .pRegFIFO        = (volatile uint32_t *)(&IOM2->FIFO),
        .pRegFIFOPTR     = (volatile uint32_t *)(&IOM2->FIFOPTR),
        .pRegFIFOTHR     = (volatile uint32_t *)(&IOM2->FIFOTHR),
        .pRegFIFOPOP     = (volatile uint32_t *)(&IOM2->FIFOPOP),
        .pRegFIFOPUSH    = (volatile uint32_t *)(&IOM2->FIFOPUSH),
        .pRegFIFOCTRL    = (volatile uint32_t *)(&IOM2->FIFOCTRL),
        .pRegFIFOLOC     = (volatile uint32_t *)(&IOM2->FIFOLOC),
        .pRegCLKCFG      = (volatile uint32_t *)(&IOM2->CLKCFG),
        .pRegSUBMODCTRL  = (volatile uint32_t *)(&IOM2->SUBMODCTRL),
        .pRegCMD         = (volatile uint32_t *)(&IOM2->CMD),
        // CMDRPT register has been repurposed for DCX
        .pRegDCX         = (volatile uint32_t *)(&IOM2->DCX),
        .pRegOFFSETHI    = (volatile uint32_t *)(&IOM2->OFFSETHI),
        .pRegCMDSTAT     = (volatile uint32_t *)(&IOM2->CMDSTAT),
        .pRegDMATRIGEN   = (volatile uint32_t *)(&IOM2->DMATRIGEN),
        .pRegDMATRIGSTAT = (volatile uint32_t *)(&IOM2->DMATRIGSTAT),
        .pRegDMACFG      = (volatile uint32_t *)(&IOM2->DMACFG),
//Intrnl.pRegDMABCOUNT   = (volatile uint32_t *)(&IOM2->DMABCOUNT),
        .pRegDMATOTCOUNT = (volatile uint32_t *)(&IOM2->DMATOTCOUNT),
        .pRegDMATARGADDR = (volatile uint32_t *)(&IOM2->DMATARGADDR),
        .pRegDMASTAT     = (volatile uint32_t *)(&IOM2->DMASTAT),
        .pRegCQCFG       = (volatile uint32_t *)(&IOM2->CQCFG),
        .pRegCQADDR      = (volatile uint32_t *)(&IOM2->CQADDR),
        .pRegCQSTAT      = (volatile uint32_t *)(&IOM2->CQSTAT),
        .pRegCQFLAGS     = (volatile uint32_t *)(&IOM2->CQFLAGS),
        .pRegCQSETCLEAR  = (volatile uint32_t *)(&IOM2->CQSETCLEAR),
        .pRegCQPAUSEEN   = (volatile uint32_t *)(&IOM2->CQPAUSEEN),
        .pRegCQCURIDX    = (volatile uint32_t *)(&IOM2->CQCURIDX),
        .pRegCQENDIDX    = (volatile uint32_t *)(&IOM2->CQENDIDX),
        .pRegSTATUS      = (volatile uint32_t *)(&IOM2->STATUS),
        .pRegMSPICFG     = (volatile uint32_t *)(&IOM2->MSPICFG),
        .pRegMI2CCFG     = (volatile uint32_t *)(&IOM2->MI2CCFG),
        .pRegDEVCFG      = (volatile uint32_t *)(&IOM2->DEVCFG),
//Intrnl.pRegDBG0        = (volatile uint32_t *)(&IOM2->DBG0),
//Intrnl.pRegDBG1        = (volatile uint32_t *)(&IOM2->DBG1),
        .pRegIOMDBG      = (volatile uint32_t *)(&IOM2->IOMDBG),
        .pRegINTEN       = (volatile uint32_t *)(&IOM2->INTEN),
        .pRegINTSTAT     = (volatile uint32_t *)(&IOM2->INTSTAT),
        .pRegINTCLR      = (volatile uint32_t *)(&IOM2->INTCLR),
        .pRegINTSET      = (volatile uint32_t *)(&IOM2->INTSET),
    },
    {
        .pRegFIFO        = (volatile uint32_t *)(&IOM3->FIFO),
        .pRegFIFOPTR     = (volatile uint32_t *)(&IOM3->FIFOPTR),
        .pRegFIFOTHR     = (volatile uint32_t *)(&IOM3->FIFOTHR),
        .pRegFIFOPOP     = (volatile uint32_t *)(&IOM3->FIFOPOP),
        .pRegFIFOPUSH    = (volatile uint32_t *)(&IOM3->FIFOPUSH),
        .pRegFIFOCTRL    = (volatile uint32_t *)(&IOM3->FIFOCTRL),
        .pRegFIFOLOC     = (volatile uint32_t *)(&IOM3->FIFOLOC),
        .pRegCLKCFG      = (volatile uint32_t *)(&IOM3->CLKCFG),
        .pRegSUBMODCTRL  = (volatile uint32_t *)(&IOM3->SUBMODCTRL),
        .pRegCMD         = (volatile uint32_t *)(&IOM3->CMD),
        // CMDRPT register has been repurposed for DCX
        .pRegDCX         = (volatile uint32_t *)(&IOM3->DCX),
        .pRegOFFSETHI    = (volatile uint32_t *)(&IOM3->OFFSETHI),
        .pRegCMDSTAT     = (volatile uint32_t *)(&IOM3->CMDSTAT),
        .pRegDMATRIGEN   = (volatile uint32_t *)(&IOM3->DMATRIGEN),
        .pRegDMATRIGSTAT = (volatile uint32_t *)(&IOM3->DMATRIGSTAT),
        .pRegDMACFG      = (volatile uint32_t *)(&IOM3->DMACFG),
//Intrnl.pRegDMABCOUNT   = (volatile uint32_t *)(&IOM3->DMABCOUNT),
        .pRegDMATOTCOUNT = (volatile uint32_t *)(&IOM3->DMATOTCOUNT),
        .pRegDMATARGADDR = (volatile uint32_t *)(&IOM3->DMATARGADDR),
        .pRegDMASTAT     = (volatile uint32_t *)(&IOM3->DMASTAT),
        .pRegCQCFG       = (volatile uint32_t *)(&IOM3->CQCFG),
        .pRegCQADDR      = (volatile uint32_t *)(&IOM3->CQADDR),
        .pRegCQSTAT      = (volatile uint32_t *)(&IOM3->CQSTAT),
        .pRegCQFLAGS     = (volatile uint32_t *)(&IOM3->CQFLAGS),
        .pRegCQSETCLEAR  = (volatile uint32_t *)(&IOM3->CQSETCLEAR),
        .pRegCQPAUSEEN   = (volatile uint32_t *)(&IOM3->CQPAUSEEN),
        .pRegCQCURIDX    = (volatile uint32_t *)(&IOM3->CQCURIDX),
        .pRegCQENDIDX    = (volatile uint32_t *)(&IOM3->CQENDIDX),
        .pRegSTATUS      = (volatile uint32_t *)(&IOM3->STATUS),
        .pRegMSPICFG     = (volatile uint32_t *)(&IOM3->MSPICFG),
        .pRegMI2CCFG     = (volatile uint32_t *)(&IOM3->MI2CCFG),
        .pRegDEVCFG      = (volatile uint32_t *)(&IOM3->DEVCFG),
//Intrnl.pRegDBG0        = (volatile uint32_t *)(&IOM3->DBG0),
//Intrnl.pRegDBG1        = (volatile uint32_t *)(&IOM3->DBG1),
        .pRegIOMDBG      = (volatile uint32_t *)(&IOM3->IOMDBG),
        .pRegINTEN       = (volatile uint32_t *)(&IOM3->INTEN),
        .pRegINTSTAT     = (volatile uint32_t *)(&IOM3->INTSTAT),
        .pRegINTCLR      = (volatile uint32_t *)(&IOM3->INTCLR),
        .pRegINTSET      = (volatile uint32_t *)(&IOM3->INTSET),
    },
    {
        .pRegFIFO        = (volatile uint32_t *)(&IOM4->FIFO),
        .pRegFIFOPTR     = (volatile uint32_t *)(&IOM4->FIFOPTR),
        .pRegFIFOTHR     = (volatile uint32_t *)(&IOM4->FIFOTHR),
        .pRegFIFOPOP     = (volatile uint32_t *)(&IOM4->FIFOPOP),
        .pRegFIFOPUSH    = (volatile uint32_t *)(&IOM4->FIFOPUSH),
        .pRegFIFOCTRL    = (volatile uint32_t *)(&IOM4->FIFOCTRL),
        .pRegFIFOLOC     = (volatile uint32_t *)(&IOM4->FIFOLOC),
        .pRegCLKCFG      = (volatile uint32_t *)(&IOM4->CLKCFG),
        .pRegSUBMODCTRL  = (volatile uint32_t *)(&IOM4->SUBMODCTRL),
        .pRegCMD         = (volatile uint32_t *)(&IOM4->CMD),
        // CMDRPT register has been repurposed for DCX
        .pRegDCX         = (volatile uint32_t *)(&IOM4->DCX),
        .pRegOFFSETHI    = (volatile uint32_t *)(&IOM4->OFFSETHI),
        .pRegCMDSTAT     = (volatile uint32_t *)(&IOM4->CMDSTAT),
        .pRegDMATRIGEN   = (volatile uint32_t *)(&IOM4->DMATRIGEN),
        .pRegDMATRIGSTAT = (volatile uint32_t *)(&IOM4->DMATRIGSTAT),
        .pRegDMACFG      = (volatile uint32_t *)(&IOM4->DMACFG),
//Intrnl.pRegDMABCOUNT   = (volatile uint32_t *)(&IOM4->DMABCOUNT),
        .pRegDMATOTCOUNT = (volatile uint32_t *)(&IOM4->DMATOTCOUNT),
        .pRegDMATARGADDR = (volatile uint32_t *)(&IOM4->DMATARGADDR),
        .pRegDMASTAT     = (volatile uint32_t *)(&IOM4->DMASTAT),
        .pRegCQCFG       = (volatile uint32_t *)(&IOM4->CQCFG),
        .pRegCQADDR      = (volatile uint32_t *)(&IOM4->CQADDR),
        .pRegCQSTAT      = (volatile uint32_t *)(&IOM4->CQSTAT),
        .pRegCQFLAGS     = (volatile uint32_t *)(&IOM4->CQFLAGS),
        .pRegCQSETCLEAR  = (volatile uint32_t *)(&IOM4->CQSETCLEAR),
        .pRegCQPAUSEEN   = (volatile uint32_t *)(&IOM4->CQPAUSEEN),
        .pRegCQCURIDX    = (volatile uint32_t *)(&IOM4->CQCURIDX),
        .pRegCQENDIDX    = (volatile uint32_t *)(&IOM4->CQENDIDX),
        .pRegSTATUS      = (volatile uint32_t *)(&IOM4->STATUS),
        .pRegMSPICFG     = (volatile uint32_t *)(&IOM4->MSPICFG),
        .pRegMI2CCFG     = (volatile uint32_t *)(&IOM4->MI2CCFG),
        .pRegDEVCFG      = (volatile uint32_t *)(&IOM4->DEVCFG),
//Intrnl.pRegDBG0        = (volatile uint32_t *)(&IOM4->DBG0),
//Intrnl.pRegDBG1        = (volatile uint32_t *)(&IOM4->DBG1),
        .pRegIOMDBG      = (volatile uint32_t *)(&IOM4->IOMDBG),
        .pRegINTEN       = (volatile uint32_t *)(&IOM4->INTEN),
        .pRegINTSTAT     = (volatile uint32_t *)(&IOM4->INTSTAT),
        .pRegINTCLR      = (volatile uint32_t *)(&IOM4->INTCLR),
        .pRegINTSET      = (volatile uint32_t *)(&IOM4->INTSET),
    },
    {
        .pRegFIFO       = (volatile uint32_t *)(&IOM5->FIFO),
        .pRegFIFOPTR    = (volatile uint32_t *)(&IOM5->FIFOPTR),
        .pRegFIFOTHR    = (volatile uint32_t *)(&IOM5->FIFOTHR),
        .pRegFIFOPOP    = (volatile uint32_t *)(&IOM5->FIFOPOP),
        .pRegFIFOPUSH   = (volatile uint32_t *)(&IOM5->FIFOPUSH),
        .pRegFIFOCTRL   = (volatile uint32_t *)(&IOM5->FIFOCTRL),
        .pRegFIFOLOC    = (volatile uint32_t *)(&IOM5->FIFOLOC),
        .pRegCLKCFG     = (volatile uint32_t *)(&IOM5->CLKCFG),
        .pRegSUBMODCTRL = (volatile uint32_t *)(&IOM5->SUBMODCTRL),
        .pRegCMD        = (volatile uint32_t *)(&IOM5->CMD),
        // CMDRPT register has been repurposed for DCX
        .pRegDCX        = (volatile uint32_t *)(&IOM5->DCX),
        .pRegOFFSETHI   = (volatile uint32_t *)(&IOM5->OFFSETHI),
        .pRegCMDSTAT    = (volatile uint32_t *)(&IOM5->CMDSTAT),
        .pRegDMATRIGEN  = (volatile uint32_t *)(&IOM5->DMATRIGEN),
        .pRegDMATRIGSTAT = (volatile uint32_t *)(&IOM5->DMATRIGSTAT),
        .pRegDMACFG     = (volatile uint32_t *)(&IOM5->DMACFG),
//Intrnl.pRegDMABCOUNT  = (volatile uint32_t *)(&IOM5->DMABCOUNT),
        .pRegDMATOTCOUNT = (volatile uint32_t *)(&IOM5->DMATOTCOUNT),
        .pRegDMATARGADDR = (volatile uint32_t *)(&IOM5->DMATARGADDR),
        .pRegDMASTAT    = (volatile uint32_t *)(&IOM5->DMASTAT),
        .pRegCQCFG      = (volatile uint32_t *)(&IOM5->CQCFG),
        .pRegCQADDR     = (volatile uint32_t *)(&IOM5->CQADDR),
        .pRegCQSTAT     = (volatile uint32_t *)(&IOM5->CQSTAT),
        .pRegCQFLAGS    = (volatile uint32_t *)(&IOM5->CQFLAGS),
        .pRegCQSETCLEAR = (volatile uint32_t *)(&IOM5->CQSETCLEAR),
        .pRegCQPAUSEEN  = (volatile uint32_t *)(&IOM5->CQPAUSEEN),
        .pRegCQCURIDX   = (volatile uint32_t *)(&IOM5->CQCURIDX),
        .pRegCQENDIDX   = (volatile uint32_t *)(&IOM5->CQENDIDX),
        .pRegSTATUS     = (volatile uint32_t *)(&IOM5->STATUS),
        .pRegMSPICFG    = (volatile uint32_t *)(&IOM5->MSPICFG),
        .pRegMI2CCFG    = (volatile uint32_t *)(&IOM5->MI2CCFG),
        .pRegDEVCFG     = (volatile uint32_t *)(&IOM5->DEVCFG),
//Intrnl.pRegDBG0       = (volatile uint32_t *)(&IOM5->DBG0),
//Intrnl.pRegDBG1       = (volatile uint32_t *)(&IOM5->DBG1),
        .pRegIOMDBG     = (volatile uint32_t *)(&IOM5->IOMDBG),
        .pRegINTEN      = (volatile uint32_t *)(&IOM5->INTEN),
        .pRegINTSTAT    = (volatile uint32_t *)(&IOM5->INTSTAT),
        .pRegINTCLR     = (volatile uint32_t *)(&IOM5->INTCLR),
        .pRegINTSET     = (volatile uint32_t *)(&IOM5->INTSET),
    },
#endif // !APOLLO3_FPGA
};
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
#if 0 // APOLLO3_FPGA
#define MAIN_CLK    (48000000 / 4)
static
uint64_t iom_get_interface_clock_cfg(uint32_t ui32FreqHz, uint32_t ui32Phase )
{
    uint32_t ui32ClkFreq, ui32ClkCfg, ui32Fsel, ui32Div3;
    uint32_t ui32DivEn, ui32TotPer, ui32LowPer;

    //
    // SPI will pass in the interface freq it needs.
    // I2C will pass in 2*ui32FreqHz to get the freq it needs.
    // For FPGA:
    //  - Main clock (HFRC) is actually (48000000 / 4).
    //  - FSEL can only be 1 or 2.  Any other value will result in 250KHz main clock.
    // So if the requested frequency is >= 2MHz, we'll use a DIV3 value (for 4MHz max).
    // Otherwise, we'll use a TOTPER value.
    //
    if ( ui32FreqHz >= 2000000 )
    {
        ui32TotPer = ui32LowPer = 0;
        if ( ui32FreqHz >= 6000000 )
        {
            ui32Div3 = 0;
            ui32Fsel = ( ui32FreqHz < 12000000) ? 2 : 1;
        }
        else
        {
            ui32Div3 = 1;
            ui32Fsel = ( ui32FreqHz < 4000000 ) ? 2 : 1;
        }
    }
    else
    {
        //
        // Determine the nearest frequency based on period and based on the
        // FPGA main clock 12MHz frequency.
        //
        ui32DivEn = 1;
        ui32Div3 = 0;
        ui32Fsel = ( ui32FreqHz <= 1000000) ? 2 : 1;

        //
        // Determine TOTPER.
        // It was originally thought that a small fudge factor would be needed
        // (e.g. via the 100/100 scaler) since the FPGA frequency is actually
        // slightly higher than 24MHz. It turned out to not be the case.
        //
        ui32TotPer = (MAIN_CLK / ui32Fsel) * 100 / 100 / ui32FreqHz;

        if ( ui32TotPer < 3 )
        {
            //
            // The lowest TotPer is 3, else a neg LowPer hangs.
            //
            ui32TotPer = 3;
        }
        ui32LowPer = ui32TotPer / 2;
    }

    //
    // If TotPer is not being used,
    //
    if ( ui32DivEn == 0 )
    {
        ui32TotPer = 1;
    ...
    ui32ClkFreq = compute_freq(MAIN_CLK, ui32Fsel, ui32Div3, ui32DivEn, ui32TotPer);
...
uint64_t iom_get_interface_clock_cfg(uint32_t ui32FreqHz, uint32_t ui32Phase )
{
    ...
    {
        case 125000:
            ui32clkcfg = 0x05021700;    // 48M/64/6
            break;
        case 200000:
            ui32clkcfg = 0x0E071500;    // 48M/16/15
            break;
        case 250000:
            ui32clkcfg = 0x00000F00;    // 48M/64/3
            break;
        case 375000:
            ui32clkcfg = 0x01001700;    // 48M/64/2
            break;
        case 400000:
            ui32clkcfg = 0x0E071400;    // 48M/8/15
            break;
        case 500000:
            ui32clkcfg = 0x00000E00;    // 48M/32/3
            break;
        case 750000:
            ui32clkcfg = 0x00000700;    // 48M/64/1
            break;
        case 800000:
            ui32clkcfg = 0x0E071300;    // 48M/4/15
            break;
        case 1000000:
            ui32clkcfg = 0x00000D00;    // 48M/16/3
            break;
        case 1500000:
            ui32clkcfg = 0x00000600;    // 48M/32/1
            break;
        case 2000000:
            ui32clkcfg = 0x00000C00;    // 48M/8/3
            break;
        case 4000000:
            ui32clkcfg = 0x00000B00;    // 48M/4/3
            break;
        case 8000000:
            ui32clkcfg = 0x00000A00;    // 48M/2/3
            break;
        case 16000000:
            ui32clkcfg = 0x00000900;    // 48M/1/3
            break;
        default:
            ui32clkcfg = ui32freq = 0;
            break;
    }

    return ( ((uint64_t)ui32freq) << 32) | (uint64_t)ui32clkcfg;
}
...
// #### INTERNAL BEGIN ####
#if 0   // CMDSTAT register is going away
    uint32_t ui32CmdStat = IOMn(ui32Module)->CMDSTAT;
    psStatus->ui32CmdCount = AM_READ_SM(AM_REG_IOM_CMDSTAT_CTSIZE,  ui32CmdStat);
    psStatus->ui32CmdStat  = AM_READ_SM(AM_REG_IOM_CMDSTAT_CMDSTAT, ui32CmdStat);
    psStatus->ui32CurrCmd  = AM_READ_SM(AM_REG_IOM_CMDSTAT_CCMD,    ui32CmdStat);
#endif
// #### INTERNAL END ####
...
#if 0
        //
        // Determine the CLKCFG value for I2C. Specify 2x the desired frequency.
        //
        ui32ClkCfg = iom_get_interface_clock_cfg(2 * psConfig->ui32ClockFreq, 0);

        //
        // Set the I2C configuration.
        //
        IOMn(ui32Module)->MI2CCFG =
            _VAL2FLD(IOM_MI2CCFG_MI2CRST, 0)    |
            // For now, we'll default on the rest of the config parameters.
            _VAL2FLD(IOM_MI2CCFG_ARBEN, 0)      |
            _VAL2FLD(IOM_MI2CCFG_SDADLY, 0)     |
            _VAL2FLD(IOM_MI2CCFG_SCLENDLY, 0)   |
            _VAL2FLD(IOM_MI2CCFG_SDAENDLY, 1);
#else
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
#if 0
                ui32ClkCfg = 0x1e131401;
                IOMn(ui32Module)->MI2CCFG = 0x1f040;
                ui32ClkCfg = 0x3c271301;
                IOMn(ui32Module)->MI2CCFG = 0x3f040;
                ui32ClkCfg = 0xf39f1101;
                IOMn(ui32Module)->MI2CCFG = 0xcf040;
                ui32ClkCfg = 0x794f1201;
                IOMn(ui32Module)->MI2CCFG = 0x6f040;
                ui32ClkCfg = 0x1;
                IOMn(ui32Module)->MI2CCFG = 0x1c;
#endif
// #### INTERNAL END ####
                break;
...
// #### INTERNAL BEGIN ####
#if 0
                ui32ClkCfg = 0x5031501;
                IOMn(ui32Module)->MI2CCFG = 0x13040;
#endif
// #### INTERNAL END ####
                //
...
// #### INTERNAL BEGIN ####
#if 0
                ui32ClkCfg = 0xf091301;
                IOMn(ui32Module)->MI2CCFG = 0x27140;
                ui32ClkCfg = 0x1f131201;
                IOMn(ui32Module)->MI2CCFG = 0x3f240;
                ui32ClkCfg = 0x3e271101;
                IOMn(ui32Module)->MI2CCFG = 0x7f440;
                ui32ClkCfg = 0x1;
                IOMn(ui32Module)->MI2CCFG = 0x52bc;
#endif
// #### INTERNAL END ####
                break;
...
#if 0
                ui32ClkCfg = 0x1f131201;
                IOMn(ui32Module)->MI2CCFG = 0x16040;
                ui32ClkCfg = 0x180c1101;
                IOMn(ui32Module)->MI2CCFG = 0x17040;
                ui32ClkCfg = 0x1;
                IOMn(ui32Module)->MI2CCFG = 0x52bc;
#endif
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
    // TODO: Would this computation change if running in burst mode?
// #### INTERNAL END ####
