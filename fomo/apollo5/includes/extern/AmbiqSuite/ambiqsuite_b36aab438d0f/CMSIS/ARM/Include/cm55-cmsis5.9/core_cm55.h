...
#define NVIC_STIR_INTID_Msk                                                    \
    ...
    typedef struct
    {
        ...
        __OM uint32_t STIR; /*!< Offset: 0x200 ( /W)  Software Triggered
                               Interrupt Register */
        __IOM uint32_t
                 RFSR; /*!< Offset: 0x204 (R/W)  RAS Fault Status Register */
...
#define SCB_AIRCR_ENDIANESS_Msk                                                \
    (1UL << SCB_AIRCR_ENDIANESS_Pos) /*!< SCB AIRCR: ENDIANNESS Mask */
...
#define SysTick_CALIB_TENMS_Msk                                                \
    ...
    typedef struct
    {
        ...
        __IM uint32_t
            DEVTYPE; /*!< Offset: 0xFCC (R/ )  ITM Device Type Register */
...
#define DWT_FUNCTION_MATCH_Msk                                                 \
    ...
    /**
      \ingroup  CMSIS_core_register
      \defgroup MemSysCtl_Type     Memory System Control Registers
      (IMPLEMENTATION DEFINED) \brief    Type definitions for the Memory System
      Control Registers (MEMSYSCTL)
      @{
     */
    ...
    typedef struct
    {
        ...
        __IOM uint32_t
            ITCMCR; /*!< Offset: 0x010 (R/W)  ITCM Control Register */
        __IOM uint32_t
            DTCMCR; /*!< Offset: 0x014 (R/W)  DTCM Control Register */
        __IOM uint32_t
                 PAHBCR; /*!< Offset: 0x018 (R/W)  P-AHB Control Register */
        uint32_t RESERVED2[313U];
        __IOM uint32_t
            ITGU_CTRL; /*!< Offset: 0x500 (R/W)  ITGU Control Register */
        __IOM uint32_t
            ITGU_CFG; /*!< Offset: 0x504 (R/W)  ITGU Configuration Register */
        uint32_t       RESERVED3[2U];
        __IOM uint32_t ITGU_LUT[16U]; /*!< Offset: 0x510 (R/W)  ITGU Look Up
                                         Table Register */
        ...
        __IOM uint32_t DTGU_LUT[16U]; /*!< Offset: 0x610 (R/W)  DTGU Look Up
                                         Table Register */
    } MemSysCtl_Type;
...
#define MEMSYSCTL_DTGU_CFG_BLKSZ_Msk                                           \
    ...
    /**
      ...
      \brief    Type definitions for the Power Mode Control Registers
      (PWRMODCTL)
      @{
     */

    /**
      \brief  Structure type to access the Power Mode Control Registers
      (PWRMODCTL).
     */
    typedef struct
    {
        __IOM uint32_t CPDLPSTATE; /*!< Offset: 0x000 (R/W)  Core Power Domain
                                      Low Power State Register */
        __IOM uint32_t DPDLPSTATE; /*!< Offset: 0x004 (R/W)  Debug Power Domain
                                      Low Power State Register */
    } PwrModCtl_Type;
...
#define PWRMODCTL_DPDLPSTATE_DLPSTATE_Msk                                      \
    ...
    typedef struct
    {
        ...
        __IM uint32_t
            EVENTMASKA; /*!< Offset: 0x080 (R/W)  Event Mask A Register */
        __IM uint32_t
...
#define EWIC_EVENTMASK_IRQ_Msk                                                 \
    ...
    typedef struct
    {
        __IOM uint32_t IEBR0; /*!< Offset: 0x000 (R/W)  Instruction Cache Error
                                 Bank Register 0 */
        __IOM uint32_t IEBR1; /*!< Offset: 0x004 (R/W)  Instruction Cache Error
                                 Bank Register 1 */
        ...
        uint32_t RESERVED1[2U];
        __IOM uint32_t
                 TEBR0; /*!< Offset: 0x020 (R/W)  TCM Error Bank Register 0 */
        uint32_t RESERVED2[1U];
        __IOM uint32_t
            TEBR1; /*!< Offset: 0x028 (R/W)  TCM Error Bank Register 1 */
    } ErrBnk_Type;
...
#define ERRBNK_TEBR1_VALID_Msk                                                 \
    ...
    {
        __OM uint32_t
            CFGINFOSEL; /*!< Offset: 0x000 ( /W)  Processor Configuration
                           Information Selection Register */
        __IM uint32_t
            CFGINFORD; /*!< Offset: 0x004 (R/ )  Processor Configuration
                          Information Read Data Register */
    } PrcCfgInf_Type;

    /* PRCCFGINF Processor Configuration Information Selection Register
     * (CFGINFOSEL) Definitions */

    /* PRCCFGINF Processor Configuration Information Read Data Register
     * (CFGINFORD) Definitions */
    ...
    typedef struct
    {
        __IM uint32_t STLNVICPENDOR; /*!< Offset: 0x000 (R/ )  NVIC Pending
                                        Priority Tree Register */
        __IM uint32_t STLNVICACTVOR; /*!< Offset: 0x004 (R/ )  NVIC Active
                                        Priority Tree Register */
        uint32_t RESERVED0[2U];
        __OM uint32_t
            STLIDMPUSR; /*!< Offset: 0x010 ( /W)  MPU Sanple Register */
        __IM uint32_t
            STLIMPUOR; /*!< Offset: 0x014 (R/ )  MPU Region Hit Register */
        __IM uint32_t STLD0MPUOR; /*!< Offset: 0x018 (R/ )  MPU Memory
                                     Attributes Register 0 */
        __IM uint32_t STLD1MPUOR; /*!< Offset: 0x01C (R/ )  MPU Memory
...
#define TPI_DEVTYPE_MajorType_Msk                                              \
    ...
    typedef struct
    {
        ...
        __IOM uint32_t
            EVTYPER[__PMU_NUM_EVENTCNT]; /*!< Offset: 0x400 (R/W)  PMU Event
                                            Type and Filter Registers */
#if __PMU_NUM_EVENTCNT < 31
        uint32_t RESERVED2[31U - __PMU_NUM_EVENTCNT];
#endif
        __IOM uint32_t CCFILTR; /*!< Offset: 0x47C (R/W)  PMU Cycle Counter
                                   Filter Register */
        uint32_t RESERVED3[480];
        __IOM uint32_t
            CNTENSET; /*!< Offset: 0xC00 (R/W)  PMU Count Enable Set Register */
        uint32_t       RESERVED4[7];
        __IOM uint32_t CNTENCLR; /*!< Offset: 0xC20 (R/W)  PMU Count Enable
                                    Clear Register */
        uint32_t       RESERVED5[7];
        __IOM uint32_t INTENSET; /*!< Offset: 0xC40 (R/W)  PMU Interrupt Enable
                                    Set Register */
        uint32_t       RESERVED6[7];
        __IOM uint32_t INTENCLR; /*!< Offset: 0xC60 (R/W)  PMU Interrupt Enable
                                    Clear Register */
        uint32_t       RESERVED7[7];
        __IOM uint32_t OVSCLR; /*!< Offset: 0xC80 (R/W)  PMU Overflow Flag
                                  Status Clear Register */
        uint32_t RESERVED8[7];
        __IOM uint32_t
            SWINC; /*!< Offset: 0xCA0 (R/W)  PMU Software Increment Register */
        uint32_t       RESERVED9[7];
        __IOM uint32_t OVSSET; /*!< Offset: 0xCC0 (R/W)  PMU Overflow Flag
                                  Status Set Register */
        ...
        __IOM uint32_t AUTHSTATUS; /*!< Offset: 0xFB8 (R/W)  PMU Authentication
                                      Status Register */
        __IOM uint32_t DEVARCH;    /*!< Offset: 0xFBC (R/W)  PMU Device
        ...
        __IOM uint32_t PIDR3; /*!< Offset: 0xFEC (R/W)  PMU Peripheral
                                 Identification Register 3 */
        __IOM uint32_t CIDR0; /*!< Offset: 0xFF0 (R/W)  PMU Component
                                 Identification Register 0 */
        __IOM uint32_t CIDR1; /*!< Offset: 0xFF4 (R/W)  PMU Component
                                 Identification Register 1 */
        __IOM uint32_t CIDR2; /*!< Offset: 0xFF8 (R/W)  PMU Component
                                 Identification Register 2 */
        __IOM uint32_t CIDR3; /*!< Offset: 0xFFC (R/W)  PMU Component
                                 Identification Register 3 */
    } PMU_Type;
...
#define FPU_MVFR2_FPMisc_Msk                                                   \
    ...
    typedef struct
    {
        ...
        __OM uint32_t DSCEMCR;    /*!< Offset: 0x010 ( /W)  Debug Set Clear
...
#define DCB_DSCSR_SBRSELEN_Msk                                                 \
    ...
    typedef struct
    {
        ...
        __IM uint32_t DAUTHSTATUS; /*!< Offset: 0x008 (R/ )  Debug
                                      Authentication Status Register */
        __IM uint32_t DDEVARCH;    /*!< Offset: 0x00C (R/ )  SCS Device
                                      Architecture Register */
        __IM uint32_t
...
#define DIB_DAUTHSTATUS_NSUNID_Pos                                             \
    18U /*!< DIB DAUTHSTATUS: Non-secure Unprivileged Non-invasive Debug Allow \
           Position */
...
#include "cachel1_armv7.h"
    ...
    /**
      ...
      \details writes to non-secure Debug Authentication Control register when
      in secure state. \param [in]  value  value to be written
     */
    ...
    /**
      ...
      secure state. \return             Debug Authentication Control Register.
     */
    ...
    /**
      ...
      secure state. \return             Debug Authentication Status Register.
     */
