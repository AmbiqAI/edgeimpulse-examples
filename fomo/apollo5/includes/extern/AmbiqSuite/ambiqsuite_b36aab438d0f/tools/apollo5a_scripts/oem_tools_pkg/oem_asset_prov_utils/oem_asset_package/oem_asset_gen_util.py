...
def parse_config_file(config, log_file):
    ...
    if config.has_option(section_name, 'OTP_SBL_WPROT4'):
        otp_sbl_wprot4_str = config.get(section_name, 'OTP_SBL_WPROT4')
        local_dict['OTP_SBL_WPROT4'] = int(otp_sbl_wprot4_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_WPROT4: Flash Write-Protection Word 4 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_SBL_WPROT5'):
        otp_sbl_wprot5_str = config.get(section_name, 'OTP_SBL_WPROT5')
        local_dict['OTP_SBL_WPROT5'] = int(otp_sbl_wprot5_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_WPROT5: Flash Write-Protection Word 5 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_SBL_WPROT6'):
        otp_sbl_wprot6_str = config.get(section_name, 'OTP_SBL_WPROT6')
        local_dict['OTP_SBL_WPROT6'] = int(otp_sbl_wprot6_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_WPROT6: Flash Write-Protection Word 6 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_SBL_WPROT7'):
        otp_sbl_wprot7_str = config.get(section_name, 'OTP_SBL_WPROT7')
        local_dict['OTP_SBL_WPROT7'] = int(otp_sbl_wprot7_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_WPROT7: Flash Write-Protection Word 7 Not Provided \n")
        return None, None
    ...
    if config.has_option(section_name, 'OTP_SBL_RPROT4'):
        otp_sbl_rprot4_str = config.get(section_name, 'OTP_SBL_RPROT4')
        local_dict['OTP_SBL_RPROT4'] = int(otp_sbl_rprot4_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_RPROT4: Flash Copy/Read-protection Word 4 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_SBL_RPROT5'):
        otp_sbl_rprot5_str = config.get(section_name, 'OTP_SBL_RPROT5')
        local_dict['OTP_SBL_RPROT5'] = int(otp_sbl_rprot5_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_RPROT5: Flash Copy/Read-protection Word 5 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_SBL_RPROT6'):
        otp_sbl_rprot6_str = config.get(section_name, 'OTP_SBL_RPROT6')
        local_dict['OTP_SBL_RPROT6'] = int(otp_sbl_rprot6_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_RPROT6: Flash Copy/Read-protection Word 6 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_SBL_RPROT7'):
        otp_sbl_rprot7_str = config.get(section_name, 'OTP_SBL_RPROT7')
        local_dict['OTP_SBL_RPROT7'] = int(otp_sbl_rprot7_str, 16)
    else:
        print_and_log(log_file, "OTP_SBL_RPROT7: Flash Copy/Read-protection Word 7 Not Provided \n")
        return None, None
    ...
    if config.has_option(section_name, 'OTP_CUST_WPROT4'):
        otp_cust_wprot4_str = config.get(section_name, 'OTP_CUST_WPROT4')
        local_dict['OTP_CUST_WPROT4'] = int(otp_cust_wprot4_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_WPROT4: Flash Write-Protection Word 4 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_CUST_WPROT5'):
        otp_cust_wprot5_str = config.get(section_name, 'OTP_CUST_WPROT5')
        local_dict['OTP_CUST_WPROT5'] = int(otp_cust_wprot5_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_WPROT5: Flash Write-Protection Word 5 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_CUST_WPROT6'):
        otp_cust_wprot6_str = config.get(section_name, 'OTP_CUST_WPROT6')
        local_dict['OTP_CUST_WPROT6'] = int(otp_cust_wprot6_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_WPROT6: Flash Write-Protection Word 6 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_CUST_WPROT7'):
        otp_cust_wprot7_str = config.get(section_name, 'OTP_CUST_WPROT7')
        local_dict['OTP_CUST_WPROT7'] = int(otp_cust_wprot7_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_WPROT7: Flash Write-Protection Word 7 Not Provided \n")
        return None, None
    ...
    if config.has_option(section_name, 'OTP_CUST_RPROT4'):
        otp_cust_rprot4_str = config.get(section_name, 'OTP_CUST_RPROT4')
        local_dict['OTP_CUST_RPROT4'] = int(otp_cust_rprot4_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_RPROT4: Flash Copy/Read-Protection Word 4 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_CUST_RPROT5'):
        otp_cust_rprot5_str = config.get(section_name, 'OTP_CUST_RPROT5')
        local_dict['OTP_CUST_RPROT5'] = int(otp_cust_rprot5_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_RPROT5: Flash Copy/Read-Protection Word 5 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_CUST_RPROT6'):
        otp_cust_rprot6_str = config.get(section_name, 'OTP_CUST_RPROT6')
        local_dict['OTP_CUST_RPROT6'] = int(otp_cust_rprot6_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_RPROT6: Flash Copy/Read-Protection Word 6 Not Provided \n")
        return None, None

    if config.has_option(section_name, 'OTP_CUST_RPROT7'):
        otp_cust_rprot7_str = config.get(section_name, 'OTP_CUST_RPROT7')
        local_dict['OTP_CUST_RPROT7'] = int(otp_cust_rprot7_str, 16)
    else:
        print_and_log(log_file, "OTP_CUST_RPROT7: Flash Copy/Read-Protection Word 7 Not Provided \n")
        return None, None
