...
//! @addtogroup apollo4l_emu_evb_disp_shield BSP for the Apollo4l Display Shield
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
am_bsp_print_interface_e g_ePrintDefault = AM_BSP_PRINT_IF_SWO;
...
am_bsp_external_display_device_enable(bool bEnable)
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_DEVICE_EN, g_AM_BSP_GPIO_MSPI2_DEVICE_EN);
    am_hal_gpio_state_write(AM_BSP_GPIO_MSPI2_DEVICE_EN, eGpioWrType);
...
am_bsp_itm_printf_disable(void)
{
    ...
    g_ePrintInterface = g_ePrintDefault;
} // am_bsp_itm_printf_disable()
...
am_bsp_disp_pins_enable(void)
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_TE,  g_AM_BSP_GPIO_MSPI2_TE);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_IFSEL1, g_AM_BSP_GPIO_MSPI2_IFSEL1);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_IFSEL2, g_AM_BSP_GPIO_MSPI2_IFSEL2);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_DEVICE_RES, g_AM_BSP_GPIO_MSPI2_DEVICE_RES);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_DEVICE_EN, g_AM_BSP_GPIO_MSPI2_DEVICE_EN);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_TOUCH_INT, g_AM_BSP_GPIO_TOUCH_INT);
    //
    // set RES pin high
    //
    am_hal_gpio_output_set(AM_BSP_GPIO_MSPI2_DEVICE_RES);
    //
    // set IM2 = 1, IM1 = 0 select to QSPI mode
    //
    am_hal_gpio_state_write(AM_BSP_GPIO_MSPI2_IFSEL2, AM_HAL_GPIO_OUTPUT_SET);
    am_hal_gpio_state_write(AM_BSP_GPIO_MSPI2_IFSEL1, AM_HAL_GPIO_OUTPUT_CLEAR);
    //
    // DISP_DEVICE_EN pin: Display Device Enable (VCI_EN).
    //
    am_hal_gpio_state_write(AM_BSP_GPIO_MSPI2_DEVICE_EN, AM_HAL_GPIO_OUTPUT_SET);
...
am_bsp_disp_pins_disable(void)
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_TE,  am_hal_gpio_pincfg_disabled);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_IFSEL1, am_hal_gpio_pincfg_disabled);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_IFSEL2, am_hal_gpio_pincfg_disabled);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_DEVICE_RES, am_hal_gpio_pincfg_disabled);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_DEVICE_EN, am_hal_gpio_pincfg_disabled);
...
am_bsp_disp_reset_pin_output_set(bool bEnable)
{
    am_hal_gpio_write_type_e eGpioWrType;
    eGpioWrType = bEnable ? AM_HAL_GPIO_OUTPUT_SET : AM_HAL_GPIO_OUTPUT_CLEAR;
    am_hal_gpio_state_write(AM_BSP_GPIO_MSPI2_DEVICE_RES, eGpioWrType);
...
//*****************************************************************************
//
//! @brief Set display enable pins.
//!
//! @return None.
//
//*****************************************************************************
static inline void
am_bsp_disp_enable_pin_output_set(bool bEnable)
{
    am_hal_gpio_write_type_e eGpioWrType;
...
//*****************************************************************************
void
am_bsp_disp_enable_pins_set(void)
{
    am_bsp_disp_enable_pin_output_set(true);
}
...
//*****************************************************************************
void
am_bsp_disp_enable_pins_clear(void)
{
    am_bsp_disp_enable_pin_output_set(false);
}
...
am_bsp_mspi_clkond4_pins_enable(uint32_t ui32Module, am_hal_mspi_device_e eMSPIDevice)
{
    switch (ui32Module)
    {
        case 0:
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                    ...
                    //
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_PSRAM_D4_CLK, g_AM_BSP_GPIO_PSRAM_D4_CLK);
                    break;
        ...
        break;
#endif /* AM_BSP_GPIO_PSRAM_D4_CLK */
    case 1:
#if (AM_BSP_GPIO_NOR_D4_CLK)
        switch ( eMSPIDevice )
        {
            case AM_HAL_MSPI_FLASH_QUAD_CE0:
            case AM_HAL_MSPI_FLASH_QUAD_CE0_1_1_4:
            ...
            case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                ...
                // clock on data pin 4.
                //
                am_hal_gpio_pinconfig(AM_BSP_GPIO_NOR_D4_CLK,  g_AM_BSP_GPIO_NOR_D4_CLK);
                break;
            ...
            case AM_HAL_MSPI_FLASH_SERIAL_CE1:
                am_hal_gpio_pinconfig(AM_BSP_GPIO_NOR_D1,  g_AM_BSP_GPIO_NOR_D1);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_NOR_D0,  g_AM_BSP_GPIO_NOR_D0);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_NOR_CE1, g_AM_BSP_GPIO_NOR_CE1);
                //
                // clock on data pin 4.
                //
                am_hal_gpio_pinconfig(AM_BSP_GPIO_NOR_D4_CLK,  g_AM_BSP_GPIO_NOR_D4_CLK);
        ...
        break;
#endif /* AM_BSP_GPIO_NOR_D4_CLK */
    case 2:
#if (AM_BSP_GPIO_MSPI2_D4_CLK)
        switch ( eMSPIDevice )
        {
            case AM_HAL_MSPI_FLASH_QUAD_CE0:
            case AM_HAL_MSPI_FLASH_QUAD_CE0_1_1_4:
        ...
        break;
#endif /* AM_BSP_GPIO_MSPI2_D4_CLK */
    default:
        break;
    }
        ...
        case 0:
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                    ...
                    // setting clock on data pin 4.
                    //
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_PSRAM_D4_CLK, am_hal_gpio_pincfg_disabled);
                    break;
                ...
                case AM_HAL_MSPI_FLASH_SERIAL_CE1:
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_PSRAM_D1,  am_hal_gpio_pincfg_disabled);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_PSRAM_D0,  am_hal_gpio_pincfg_disabled);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_PSRAM_CE1, am_hal_gpio_pincfg_disabled);
                    //
                    // setting clock on data pin 4.
                    //
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_PSRAM_D4_CLK, am_hal_gpio_pincfg_disabled);
    ...
    case 1:
        ...
        switch ( eMSPIDevice )
        {
            ...
            case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                ...
                // clock on data pin 4.
                //
                am_hal_gpio_pinconfig(AM_BSP_GPIO_NOR_D4_CLK,  am_hal_gpio_pincfg_disabled);
                break;
    ...
    case 2:
        ...
        switch ( eMSPIDevice )
        {
            ...
            case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                ...
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_D0,  g_AM_BSP_GPIO_MSPI2_D0);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_D1,  g_AM_BSP_GPIO_MSPI2_D1);
                if ( g_sDispCfg.ui32Module == 2 && g_sDispCfg.bClockonD4 == true )
                {
