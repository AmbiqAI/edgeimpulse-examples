...
#define MSPI1_GROUP_QSPI_DISP           3
...
#define MSPI2_GROUP_DISP_COOPER_EMMC_D4_D7         4
...
#define IOM2_GROUP_DISP                 4

//IOM3 group
#define IOM3_GROUP_HZ                   0
#define IOM3_GROUP_PC_HARNESS           1
#define IOM3_GROUP_PSRAM                2
#define IOM3_GROUP_FRAM                 3

//IOM4 group
#define IOM4_GROUP_HZ                   0
#define IOM4_GROUP_PC_HARNESS           1
#define IOM4_GROUP_PSRAM                2
#define IOM4_GROUP_FRAM                 3
#define IOM4_GROUP_DISP_COOPER          4
