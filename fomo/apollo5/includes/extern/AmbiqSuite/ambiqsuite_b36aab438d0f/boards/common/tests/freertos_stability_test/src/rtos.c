...
setup_task(void *pvParameters)
{
  ...
  //
  xTaskCreate(RadioTask, "RadioTask", 512, 0, 6, &radio_task_handle);
  xTaskCreate(HRMTask, "HRMTask", 512, 0, 5, &HRMTaskHandle);
  xTaskCreate(GPSTask, "GPSTask", 512, 0, 4, &GPSTaskHandle);
  xTaskCreate(FlashTask, "FlashTask", 512, 0, 3, &FlashTaskHandle);
  xTaskCreate(LCDTask, "LCDTask", 512, 0, 2, &LCDTaskHandle);
  xTaskCreate(RTCTask, "RTCTask", 512, 0, 1, &RTCTaskHandle);
