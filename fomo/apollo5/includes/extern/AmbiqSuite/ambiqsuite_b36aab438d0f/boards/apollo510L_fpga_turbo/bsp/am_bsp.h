...
//! @addtogroup apollo5b_fpga_turbo BSP
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
#define USE_MSPI_CTRL
#define USE_SDIO_CTRL
#define USE_PDM_CTRL
// #### INTERNAL BEGIN ####
#warning define the necessary USE_*_CTRL here to enable bsp functions.
// #### INTERNAL END ####
