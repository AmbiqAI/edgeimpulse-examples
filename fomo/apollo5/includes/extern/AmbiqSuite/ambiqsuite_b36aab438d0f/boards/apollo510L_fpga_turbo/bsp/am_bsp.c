...
//! @addtogroup apollo510L_fpga_turbo BSP
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
// #### INTERNAL END ####
    {
        ...
        {
// #### INTERNAL BEGIN ####
            if (!(MCUCTRL->BOOTLOADER & (MCUCTRL_BOOTLOADER_SBLUNLOCK_Msk | MCUCTRL_BOOTLOADER_SBRUNLOCK_Msk)))
            {
...
//#warning "If running the QSPI interface, please keep Jump J22,J23 open."
    ...
    {
        case DISP_IF_QSPI:
            am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_CS_N,  g_AM_BSP_GPIO_DISP_QSPI_CS_N);
        ...
        case DISP_IF_DSPI:
        case DISP_IF_SPI4:
            am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_SPI_CS_N,  g_AM_BSP_GPIO_DISP_SPI_CS_N);
...
am_bsp_disp_pins_disable(void)
{
    ...
    {
        case DISP_IF_QSPI:
            am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_CS_N,  am_hal_gpio_pincfg_disabled);
        ...
        case DISP_IF_DSPI:
        case DISP_IF_SPI4:
            am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_SPI_CS_N,  am_hal_gpio_pincfg_disabled);
...
am_bsp_ios_pins_enable(uint32_t ui32Module, uint32_t ui32IOSMode)
{
    ...
    switch ( ui32Combined )
    {
        ...
        case ((0 << 2) | AM_HAL_IOS_USE_I2C):
            am_hal_gpio_pinconfig(AM_BSP_GPIO_IOSFD0_SCL,  g_AM_BSP_GPIO_IOSFD0_SCL);
            am_hal_gpio_pinconfig(AM_BSP_GPIO_IOSFD0_SDA,  g_AM_BSP_GPIO_IOSFD0_SDA);
            break;
...
am_bsp_ios_pins_disable(uint32_t ui32Module, uint32_t ui32IOSMode)
{
    ...
    switch ( ui32Combined )
    {
        ...
        case ((0 << 2) | AM_HAL_IOS_USE_I2C):
            am_hal_gpio_pinconfig(AM_BSP_GPIO_IOSFD0_SCL,  am_hal_gpio_pincfg_disabled);
            am_hal_gpio_pinconfig(AM_BSP_GPIO_IOSFD0_SDA,  am_hal_gpio_pincfg_disabled);
            break;
...
#endif // MCU_VALIDATION
// #### INTERNAL BEGIN ####
#if 0 // Not needed for Apollo5b and later. CAYNSWS-1513
//*****************************************************************************
//
