...
//! @addtogroup apollo4l_fpga_ps BSP
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
//!
//! This function configures reset,te,en,mode select sometimes with clock/data pins
//!
//! @return None.
//
//*****************************************************************************
...
{
    if ( g_sDispCfg.eDeviceConfig == AM_HAL_MSPI_FLASH_SERIAL_CE0 )
    {
        am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_CE0, g_AM_BSP_GPIO_MSPI2_CE0);
    }
    else if ( g_sDispCfg.eDeviceConfig == AM_HAL_MSPI_FLASH_SERIAL_CE1 )
    {
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_OLEDEN, g_AM_BSP_GPIO_MSPI2_OLEDEN);
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_TE,  g_AM_BSP_GPIO_MSPI2_TE);

    am_hal_gpio_output_set(AM_BSP_GPIO_MSPI2_RES);
    am_hal_gpio_state_write(AM_BSP_GPIO_MSPI2_OLEDEN, AM_HAL_GPIO_OUTPUT_SET);
...
am_bsp_disp_pins_disable(void)
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_OLEDEN, am_hal_gpio_pincfg_disabled);
