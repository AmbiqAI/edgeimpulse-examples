...
am_bsp_iom_psram_pins_enable(void)
{
    ...
    am_hal_gpio_pinconfig(AM_HAL_PIN_23_M7MOSI, g_AM_BSP_GPIO_IOM_PSRAM_MOSI);
    am_hal_gpio_pinconfig(AM_HAL_PIN_24_M7MISO, g_AM_BSP_GPIO_IOM_PSRAM_MISO);
    am_hal_gpio_pinconfig(AM_HAL_PIN_22_M7SCK, g_AM_BSP_GPIO_IOM_PSRAM_SCK);
...
{
    am_hal_gpio_pinconfig(AM_HAL_PIN_23_M7MOSI, am_hal_gpio_pincfg_disabled);
    am_hal_gpio_pinconfig(AM_HAL_PIN_24_M7MISO, am_hal_gpio_pincfg_disabled);
    am_hal_gpio_pinconfig(AM_HAL_PIN_22_M7SCK, am_hal_gpio_pincfg_disabled);
