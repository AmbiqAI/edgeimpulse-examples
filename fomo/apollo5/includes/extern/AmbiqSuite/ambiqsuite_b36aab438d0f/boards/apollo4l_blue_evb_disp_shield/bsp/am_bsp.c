...
//*****************************************************************************
//
// Enable the IOM pins based on mode and module.
//
//*****************************************************************************
void
...
//*****************************************************************************
//
// Set up the MSPI mux switch to the external flash device.
//
//*****************************************************************************
static void
...
//*****************************************************************************
//
// Set up the MSPI mux switch to the external psram device.
//
//*****************************************************************************
static void
...
//*****************************************************************************
//
// Set up the MSPI mux switch disable.
//
//*****************************************************************************
static void
    ...
    switch (ui32Module)
    {
        ...
        case 2:
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_QUAD_CE0_1_1_4:
                case AM_HAL_MSPI_FLASH_QUAD_CE0_1_4_4:
                    *pPinnum = AM_BSP_GPIO_DISP_QSPI_CS;
                    *pPincfg = g_AM_BSP_GPIO_DISP_QSPI_CS;
                default:
                    break;
            }
            break;
...
am_bsp_disp_pins_enable(void)
{
   ...
   //
   // to be fixed, for conflit with MSPI2_CE function
   //
   // am_hal_gpio_pinconfig(AM_BSP_GPIO_TOUCH_INT, g_AM_BSP_GPIO_TOUCH_INT);
#endif
...
//
//*****************************************************************************
void am_bsp_external_display_device_enable(bool bEnable) {}

//*****************************************************************************
//
// Accelerometer device enable on the apollop4p_evb_disp_shield board.
//
//*****************************************************************************
void am_bsp_external_accel_device_enable(bool bEnable)
{
    am_hal_gpio_write_type_e eGpioWrType;
    eGpioWrType = bEnable ? AM_HAL_GPIO_OUTPUT_SET : AM_HAL_GPIO_OUTPUT_CLEAR;
