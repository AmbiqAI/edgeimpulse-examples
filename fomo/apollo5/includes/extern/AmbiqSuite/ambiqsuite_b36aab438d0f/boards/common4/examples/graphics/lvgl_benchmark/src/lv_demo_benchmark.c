...
static void img_rgb_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_rgb.data, img_cogwheel_rgb_ambiq_bgr24, img_benchmark_cogwheel_rgb.data_size);
...
static void img_argb_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_argb.data, img_cogwheel_argb_ambiq_bgra8888, img_benchmark_cogwheel_argb.data_size);
...
static void img_ckey_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_chroma_keyed.data, img_cogwheel_chroma_keyed_ambiq_bgr24, img_benchmark_cogwheel_chroma_keyed.data_size);
...
static void img_index_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_indexed16.data, img_cogwheel_indexed16_ambiq_indices, img_benchmark_cogwheel_indexed16.data_size);
...
static void img_alpha_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_alpha16.data, img_cogwheel_argb_a16_ambiq_a4, img_benchmark_cogwheel_alpha16.data_size);
...
static void img_rgb_rot_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_rgb.data, img_cogwheel_rgb_ambiq_z_bgr24, img_benchmark_cogwheel_rgb.data_size);
...
static void img_argb_rot_cb(void)
{
    ...
    memcpy((void*)img_benchmark_cogwheel_argb.data, img_cogwheel_argb_ambiq_z_bgra8888, img_benchmark_cogwheel_argb.data_size);
