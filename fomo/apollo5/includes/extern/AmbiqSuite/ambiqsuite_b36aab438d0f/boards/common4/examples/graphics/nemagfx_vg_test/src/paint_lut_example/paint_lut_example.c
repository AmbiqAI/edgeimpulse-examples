...
static nema_img_obj_t fb = {{0}, RESX, RESY, RESX*3, 0, NEMA_RGB24, 0};
...
#ifndef DONT_USE_NEMADC
static nemadc_layer_t dc_layer = {(void *)0, 0, RESX, RESY, -1, 0, 0, RESX, RESY, 0xff, NEMADC_BL_SRC, 0, NEMADC_RGB24, 0, 0, 0, 0, 0, 0, 0, 0};
#endif
