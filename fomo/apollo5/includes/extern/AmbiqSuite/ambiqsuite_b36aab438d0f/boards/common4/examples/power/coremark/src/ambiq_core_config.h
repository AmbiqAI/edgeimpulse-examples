...
//     can be verified.  This stage utilizes TIMER A0 using HCLK as a source.
//  3. The third stage turns off the pad used in step 2, but leaves the TIMER
...
#define AM_CORECLK_192MHZ                   (AM_HAL_CLKGEN_FREQ_MAX_MHZ * 2)
