//*****************************************************************************
//
//! @file load_section_on_demand.c
//!
//! @brief Example of the MSPI operation with external processor.
//!
//! Purpose: This example shows how to load overlay section with an MSPI
...
main(void)
{
    ...
    //
    am_util_debug_printf("***** Please enable LOAD_ELF_VIA_REMOTEPROC macro *****\r\n");
    am_util_debug_printf("Load Overlay Section Example\r\n");
