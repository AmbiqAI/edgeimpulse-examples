//*****************************************************************************
//
//! @file cellular_menu.h
//!
//! @brief Functions and variables related to the cellular menu.
//!
//*****************************************************************************
...
#ifndef CELLULAR_MENU_H
#define CELLULAR_MENU_H
...
void c_menu_init(lv_obj_t *base_obj);
void load_texture_c_menu(void);
