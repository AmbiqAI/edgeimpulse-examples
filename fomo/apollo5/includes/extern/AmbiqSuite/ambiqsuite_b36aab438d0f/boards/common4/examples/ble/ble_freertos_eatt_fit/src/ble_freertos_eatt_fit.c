//*****************************************************************************
//
//! @file ble_freertos_eatt_fit.c
//!
//! @brief ARM Cordio BLE - EATT Fit Application Example.
//!
//! @addtogroup ble_examples BLE Examples
//!
//! @defgroup ble_freertos_eatt_fit BLE FreeRTOS EATT Fit Application Example
//! @ingroup ble_examples
//! @{
//!
//! Purpose: This example similar to BLE Fit example but performs the
...
//
//*****************************************************************************
#include "ble_freertos_eatt_fit.h"
#include "rtos.h"
