...
//!
//! @brief NemaGFX NemaGUI Ambiq Logo Example
//!
//! @addtogroup graphics_examples Graphics Examples
//!
//! @defgroup nemagfx_nemagui_ambiq_logo NemaGFX NemaGUI Ambiq Logo Example
//! @ingroup graphics_examples
//! @{
//!
//! Purpose: There is a guiBuilder
...
main(void)
{
    ...
    #if ( STREAM_COLOR_FORMAT == COLOR_FORMAT_RGB565 )
        g_sDispCfg.eDsiFreq = AM_HAL_DSI_FREQ_TRIM_X13;
    #endif
#endif

#if (defined(SCENARIO_C))
