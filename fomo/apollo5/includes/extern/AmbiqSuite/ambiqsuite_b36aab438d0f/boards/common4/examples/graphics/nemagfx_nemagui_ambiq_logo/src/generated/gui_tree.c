...
#include "images.h"
    ...
    gitem_digital_clock_t _17DigitalClock = {EVENT(NULL), ng_digital_clock_draw, GESTURES(NULL), FLAGS(0x00000080U), X(0), Y(0), W(390), H(390), ID(17), GITEM_DIGITAL_CLOCK , COLOR(0xff000000U), TEXT_COLOR(0xFFe6e6e7U), &NotoSans_Regular70pt8b, NEMA_ALIGNX_CENTER | NEMA_ALIGNY_CENTER, TIME_FORMAT(NG_TIME_H_MM)};
    ...
    gitem_digital_clock_t _17DigitalClock = {EVENT(NULL), ng_digital_clock_draw, GESTURES(NULL), FLAGS(0x00000080U), X(0), Y(0), W(455), H(455), ID(17), GITEM_DIGITAL_CLOCK , COLOR(0xff000000U), TEXT_COLOR(0xFFe6e6e7U), &NotoSans_Regular80pt8b, NEMA_ALIGNX_CENTER | NEMA_ALIGNY_CENTER, TIME_FORMAT(NG_TIME_H_MM)};
