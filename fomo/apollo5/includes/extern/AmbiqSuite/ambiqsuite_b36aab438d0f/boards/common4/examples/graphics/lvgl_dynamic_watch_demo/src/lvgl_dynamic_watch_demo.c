//*****************************************************************************
//
//! @file lvgl_dynamic_watch_demo.c
//!
//! @brief LVGL Dynamic Watch example.
//!
//! @addtogroup graphics_examples Graphics Examples
//!
//! @defgroup lvgl_dynamic_watch_demo LVGL Dynamic Watch Example
//! @ingroup graphics_examples
//! @{
//!
//! Purpose: This example demonstrates how to use LVGL to create a watchface demo.
//! Textures need to loaded to EMMC via tinyusb_cdc_msc_emmc example before
//! running this example. tinyusb_cdc_msc_emmc.bin is located in following path.
//! boards\common4\examples\graphics\lvgl_dynamic_watch_demo\textures_loader\tinyusb_cdc_msc_emmc.bin
//!
//! Textures is located in following path.
//! boards\common4\examples\graphics\lvgl_dynamic_watch_demo\textures_loader\lvgl_dynamic_watch_demo_20231128.zip
//! All of files in this folder need be loaded
//!
//! You need to change the display Settings in the bsp as following:
//! Set .ui16ResX in g_sDispCfg to 468;
//! Set .ui16ResY in g_sDispCfg to 468;
//! Set .ui16Offset in g_sDispCfg to 6;
//*****************************************************************************
//*****************************************************************************
//
// ${copyright}
...
main(void)
{
    ...
    //
    am_util_stdio_printf("lvgl watch demo\n");
