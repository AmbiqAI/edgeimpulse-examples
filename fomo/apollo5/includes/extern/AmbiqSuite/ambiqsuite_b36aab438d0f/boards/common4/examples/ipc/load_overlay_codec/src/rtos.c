...
setup_task(void *pvParameters)
{
    ...
    if ( init_ambt53() )
    {
        am_util_debug_printf("Init ambt53 fail\r\n");
    }
    else
    {
        /*Create the functional tasks*/
        metal_thread_init(&load_mp3_task_handle, LoadMP3Task, "LoadMP3Task", 1024, 0, 3);
        metal_thread_init(&load_aac_task_handle, LoadAACTask, "LoadAACTask", 1024, 0, 3);
    }
