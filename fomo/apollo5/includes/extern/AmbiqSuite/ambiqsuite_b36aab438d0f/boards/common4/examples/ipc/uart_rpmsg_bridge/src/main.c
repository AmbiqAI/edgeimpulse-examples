...
//! @file main.c
//!
//! @brief Example of the uart bridge.
//!
//! Purpose: This exapmle can be used as a way to communicate HCI cmds and events
//! between a host chip using UART RPMSG and the AMBT53 module inside Apollo4.
//!
...
main(void)
{
    ...
    //
    am_util_stdio_printf("Apollo4 UART to RPMSG Bridge BaudRate = 921600\n");
