...
//!
//! @brief NemaGFX TSC Frame Buffer PSRAM XIPMM Example.
//!
//! @addtogroup graphics_examples Graphics Examples
//!
//! @defgroup nemagfx_tsc_fb_psram_xipmm NemaGFX TSC Frame Buffer PSRAM XIPMM Example
//! @ingroup graphics_examples
//! @{
//!
//! Purpose: nemagfx_tsc_fb_psram_xipmm is a demo of TSC frame-buffer compression with
...
// #### INTERNAL BEGIN ####
#if 0
    // Quick experiment with cache enabled.
...
// #### INTERNAL END ####
...
#ifndef AM_PART_APOLLO4P
    ui32Status = am_devices_mspi_psram_write(g_pDevHandle, (uint8_t *)g_ui8Oli400x400Tsc4, 0x0, sizeof(g_ui8Oli400x400Tsc4), true);
#else
    ...
    //
    // Set 64MB XIP range. Hardcode workaround for MSPI0 XIP.
    //
    *(uint32_t *)(0x40060080) = ((*(volatile uint32_t *)(0x40060080)) & 0xFFFFFFF0) | (0x0000000A);
    //
    // Enable XIP mode.
    //
#ifndef AM_PART_APOLLO4P
    ...
    //
    memcpy((uint32_t *)MSPI_XIPMM_BASE_ADDRESS, g_ui8Oli400x400Tsc4, sizeof(g_ui8Oli400x400Tsc4));
#endif
