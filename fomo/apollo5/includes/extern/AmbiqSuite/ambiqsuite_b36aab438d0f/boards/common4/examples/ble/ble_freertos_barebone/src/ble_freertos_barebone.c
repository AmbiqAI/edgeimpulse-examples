...
//!
//! @brief BLE FreeRTOS Barebones Application.
//!
//! @addtogroup ble_examples BLE Examples
//!
//! @defgroup ble_freertos_barebone BLE FreeRTOS Barebones Example
//! @ingroup ble_examples
//! @{
//!
//! Purpose: This example implements a BLE barebone proejct within the FreeRTOS
