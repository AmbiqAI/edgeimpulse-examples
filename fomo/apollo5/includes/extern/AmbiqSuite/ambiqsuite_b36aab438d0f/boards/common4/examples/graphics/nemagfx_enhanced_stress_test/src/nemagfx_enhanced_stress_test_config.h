 ...
 */
#elif defined(apollo4p_bga_sys_test)|| defined(apollo4p_bga_sys_test_rev2)
...
#define MSPI_TASK_ENABLE       0     // When MSPI0 is at hex mode, we couldn't use MSPI1
...
#define PSRAM_APS25616N
#define NAND_FLASH_DOSILICON_DS35X1GA
#define IOM_INSTANCE_TO_PSRAM           {0,1,5,6}
#define SDIO_BUS_WIDTH                  (AM_HAL_HOST_BUS_WIDTH_4)
#if (XIP_TASK_ENABLE == 1)
#define XIP_IN_PSRAM
#endif  //(XIP_TASK_ENABLE == 1)
...
#define PSRAM_APS25616N
#define NAND_FLASH_DOSILICON_DS35X1GA
#define IOM_INSTANCE_TO_PSRAM           {5}
 ...
 */
#elif defined(apollo4p_evb_disp_shield_rev2) 

#define HPLP_TASK_ENABLE       1
#define XIP_TASK_ENABLE        0 // IAR is not suupoerted in xip_task.c
#define CRYPTO_TASK_ENABLE     1
#define GUI_TASK_ENABLE        1
#define RENDER_TASK_ENABLE     1
#define DISPLAY_TASK_ENABLE    1
#define MSPI_TASK_ENABLE       1
#define IOMPSRAM_TASK_ENABLE   0 // Should not work as nothing is connected to IOM.
#define ADC_TASK_ENABLE        1
#define EMMC_TASK_ENABLE       1
#define UART_TASK_ENABLE       0
#define USB_TASK_ENABLE        1
