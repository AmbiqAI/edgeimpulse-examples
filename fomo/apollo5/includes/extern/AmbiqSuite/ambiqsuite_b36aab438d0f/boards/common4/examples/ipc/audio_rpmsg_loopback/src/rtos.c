...
setup_task(void *pvParameters)
{
    ...
    //
    metal_thread_init(&rpmsg_recv_task_handle, RPMsgReceiveTask, "RPMsgReceiveTask", 1024, 0, 4);
    metal_thread_init(&rpmsg_send_task_handle, RPMsgSendTask, "RPMsgSendTask", 1024, 0, 3);
