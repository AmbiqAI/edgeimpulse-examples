...
//!
//! @brief LVGL GPU acceleration example.
//! This example demonstrates how to use LVGL to create a watch demo.
//! In this example, the following features are demonstrate.
//! 1. LVGL with Ambiq GPU acceleration.
//! 2. File system on EMMC
//! 3. TSVG format image rendering with GPU.
//! Read the HOW_TO_RUN.md for quick start guidance.
//*****************************************************************************
//*****************************************************************************
//
// ${copyright}
