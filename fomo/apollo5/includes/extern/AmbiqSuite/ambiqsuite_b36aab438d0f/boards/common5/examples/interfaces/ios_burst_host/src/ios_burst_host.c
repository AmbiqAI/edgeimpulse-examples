...
//!     --------------------                    ----------------
//!     GPIO[8]  IOM1 SPI SCK                   GPIO[11]  IOS SPI SCK
//!     GPIO[9]  IOM1 SPI MOSI                  GPIO[52]  IOS SPI MOSI
//!     GPIO[10] IOM1 SPI MISO                  GPIO[83]  IOS SPI MISO
//!     GPIO[92] IOM1 SPI nCE                   GPIO[13]  IOS SPI nCE
...
int main(void)
{
    ...
    am_util_stdio_printf("IOS *Burst* [HOST] Example\n");
    am_util_stdio_printf("\n");
    ...
    am_util_stdio_printf("\t\t|--------------------|                    |--------------------|\n");
    am_util_stdio_printf("\t\t|   %3d (MOSI)       |-----MOSI------>----|   %3d (MOSI)       |\n", AM_BSP_GPIO_IOM1_MOSI, AM_BSP_GPIO_IOS_MOSI);
    am_util_stdio_printf("\t\t|                    |                    |                    |\n");
    am_util_stdio_printf("\t\t|   %3d (MISO)       |----<----MISO-------|   %3d (MISO)       |\n", AM_BSP_GPIO_IOM1_MISO, AM_BSP_GPIO_IOS_MISO);
    am_util_stdio_printf("\t\t|                    |                    |                    |\n");
    am_util_stdio_printf("\t\t|   %3d (SCK)        |-----SCK------->----|   %3d (SCK)        |\n", AM_BSP_GPIO_IOM1_SCK, AM_BSP_GPIO_IOS_SCK);
    am_util_stdio_printf("\t\t|                    |                    |                    |\n");
    am_util_stdio_printf("\t\t|   %3d (nCE)        |-----nCE------->----|   %3d (nCS)        |\n", AM_BSP_GPIO_IOM1_CS, AM_BSP_GPIO_IOS_CE);
    am_util_stdio_printf("\t\t|                    |                    |                    |\n");
    am_util_stdio_printf("\t\t|   %3d (INT)        |----<---HANDSHAKE---|   %3d (HANDSHAKE)  |\n", HANDSHAKE_IOM_PIN , HANDSHAKE_IOM_PIN);
    am_util_stdio_printf("\t\t|                    |                    |                    |\n");
