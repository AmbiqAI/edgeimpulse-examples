...
//!
//! @defgroup ble_freertos_amdtpc BLE FreeRTOS AMDTP Client (Master) Example
...
setup_serial(int32_t i32Module)
{
    ...
    {
        //
        // Standard UART settings: 460800-8-N-1
        //
        .ui32BaudRate = 460800,
       //
    ...
    am_hal_uart_initialize(AM_BSP_UART_PRINT_INST, &UART);
