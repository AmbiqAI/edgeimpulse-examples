...
//
//*****************************************************************************
void tcm_heap_init(uint32_t start_addr, uint32_t heap_size_in_byte,
...
//
//*****************************************************************************
void* tcm_heap_malloc(uint32_t size_in_byte)
{
...
void * tcm_heap_realloc(void * ptr, size_t size)
{
    uint32_t address = (uint32_t)ptr - simple_malloc_core.start_address;
