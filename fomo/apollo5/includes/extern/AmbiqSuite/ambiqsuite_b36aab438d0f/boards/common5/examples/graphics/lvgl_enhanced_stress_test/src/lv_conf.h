...
#include <stdint.h>
#include "lvgl_enhanced_stress_test_config.h"
...
#define LV_TICK_CUSTOM_INCLUDE  "lvgl_enhanced_stress_test.h"         /*Header for the system time function*/
...
#  define LV_MEM_PSRAM_SIZE (PSRAM_TEXTURE_AREA_SIZE)         /*[bytes]*/
/*Set an address for the PSRAM heap*/
#  define LV_MEM_PSRAM_ADR (PSRAM_XIP_BASE_ADDRESS + PSRAM_TEXTURE_AREA_OFFSET)    /*0: unused*/

#if LV_MEM_CUSTOM == 1
#define LV_MEM_CUSTOM_INCLUDE "lv_simple_malloc.h"

#define LV_MEM_CUSTOM_TCM_ALLOC  tcm_heap_malloc
#define LV_MEM_CUSTOM_TCM_FREE tcm_heap_free
#define LV_MEM_CUSTOM_TCM_REALLOC tcm_heap_realloc

#define LV_MEM_CUSTOM_SSRAM_ALLOC  ssram_heap_malloc
#define LV_MEM_CUSTOM_SSRAM_FREE ssram_heap_free
#define LV_MEM_CUSTOM_SSRAM_REALLOC ssram_heap_realloc

#define LV_MEM_CUSTOM_PSRAM_ALLOC  psram_heap_malloc
#define LV_MEM_CUSTOM_PSRAM_FREE psram_heap_free
#define LV_MEM_CUSTOM_PSRAM_REALLOC psram_heap_realloc
#endif
