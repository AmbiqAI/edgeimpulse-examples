...
#include "texture/simhei36pt1b.h"
#include "texture/simhei36pt4b.h"
#include "texture/simhei36pt8b.h"
#include "texture/arial48pt1b.h"

#include "psram_malloc.h"

#include "texture/greek_island_100x100_alpha_rgba.h"
#include "texture/greek_island_100x100_rgba565.h"
#include "texture/greek_island_100x100_tsc6.h"
#include "texture/greek_island_100x100_tsc4.h"
#include "texture/greek_island_100x100_tsc6a.h"
#include "texture/greek_island_200x200_rgba.h"
#include "texture/greek_island_32x32_rgba.h"

#include "texture/hour_20x250_rgba.h"
#include "texture/hour_20x250_tsc6.h"
#include "texture/hour_20x250_tsc6a.h"
#include "texture/fz250_rgb24_100x100.h"
#include "texture/fz250_99x99_rgba.h"
#include "texture/monkey_trans_48x48_tsc6a.h"
#include "texture/girl_tsc6.h"
#include "texture/watchface_star_360x360_tsc6a.h"
#include "texture/oli_390x390_alpha_rgba565.h"
#include "texture/sport_150x168_rgba565.h"
...
static const unsigned long YELLOW    = 0xFF00FFFF;
...
test_nema_malloc(void)
{
    ...
    for (i = 0; i < 100; i++)
    {
        g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS, 360*360*3);
...
load_objects(void)
{
    ...
    g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_FB, align16(g_sFB.w*g_sFB.h*4));

    g_sDCLayer.format = NEMADC_RGBA8888;
    g_sDCLayer.baseaddr_phys = g_sFB.bo.base_phys;
    g_sDCLayer.baseaddr_virt = g_sFB.bo.base_virt;

//    greek_islend.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS, greek_islend_100x100_alpha_rgba_length);
...
tsuite2d_tileblit(void)
{
    ...
    obj_greek_island_32x32_rgba.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS, sizeof(g_ui8GreekIsland32x32RGBA));
    if ( NULL == obj_greek_island_32x32_rgba.bo.base_phys )
    {
        while(1);           //error
    }
    nema_memcpy((void*)obj_greek_island_32x32_rgba.bo.base_phys, g_ui8GreekIsland32x32RGBA, sizeof(g_ui8GreekIsland32x32RGBA));
...
blit_texture_100x100_tile(void)
{
    ...
    g_sGreekIslandRGBA8888.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS, sizeof(g_ui8GreekIsland100x100RGBA));
    if ( NULL == g_sGreekIslandRGBA8888.bo.base_phys )
    {
        while(1);           //error
    }
    nema_memcpy((void*)g_sGreekIslandRGBA8888.bo.base_phys, g_ui8GreekIsland100x100RGBA, sizeof(g_ui8GreekIsland100x100RGBA));
...
void blit_texture_200x200(void)
{
    ...
    obj_greek_islend_200x200_rgba.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS, sizeof(g_ui8GreekIsland200x200RGBA));
    if ( NULL == obj_greek_islend_200x200_rgba.bo.base_phys )
    {
        while(1);           //error
    }
    nema_memcpy((void*)obj_greek_islend_200x200_rgba.bo.base_phys, g_ui8GreekIsland200x200RGBA, sizeof(g_ui8GreekIsland200x200RGBA));
...
void
blit_texture_390x390(void)
{
    img_obj_t obj_oli_390x390_alpha_rgba565 = {{0}, 390, 390, -1, 0, NEMA_RGB565, 0};
    ...
    obj_oli_390x390_alpha_rgba565.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS, sizeof(g_ui8Oli390x390RGBA565));
    if ( NULL == obj_oli_390x390_alpha_rgba565.bo.base_phys )
    {
        while(1);           //error
    }
    nema_memcpy((void*)obj_oli_390x390_alpha_rgba565.bo.base_phys, g_ui8Oli390x390RGBA565, sizeof(g_ui8Oli390x390RGBA565));
    nema_bind_src_tex(obj_oli_390x390_alpha_rgba565.bo.base_phys,
                      obj_oli_390x390_alpha_rgba565.w,
                      obj_oli_390x390_alpha_rgba565.h,
                      obj_oli_390x390_alpha_rgba565.format,
                      obj_oli_390x390_alpha_rgba565.stride,
                      NEMA_FILTER_PS);
    nema_set_clip(0, 0, RESX, RESY);
    nema_set_blend_blit(NEMA_BL_SRC);
    start_time = nema_get_time();
    ...
    end_time = nema_get_time();
    am_util_stdio_printf("blit_texture_390x390 rgba565 used %f s\n", end_time - start_time);
    ...
    nema_buffer_destroy(&obj_oli_390x390_alpha_rgba565.bo);
}
...
{
    g_sSimhei36pt1b.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS,  align16(g_sSimhei36pt1b.bitmap_size) );
    ...
    g_sSimhei36pt4b.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS,  align16(g_sSimhei36pt4b.bitmap_size) );
    ...
    g_sSimhei36pt8b.bo = nema_buffer_create_pool(NEMA_MEM_POOL_ASSETS,  align16(g_sSimhei36pt8b.bitmap_size) );
...
blit_font_psram(void)
{
    ...
    nema_bind_font(&g_sSimhei36pt1b);
    char *psram_simhei36pt1bBitmaps = psram_heap_malloc(g_sSimhei36pt1b.bitmap_size);
    nema_memcpy(psram_simhei36pt1bBitmaps, g_sSimhei36pt1b.bitmap, g_sSimhei36pt1b.bitmap_size);
    ...
    nema_bind_font(&g_sSimhei36pt4b);
    char *psram_simhei36pt4bBitmaps = psram_heap_malloc(g_sSimhei36pt4b.bitmap_size);
    nema_memcpy(psram_simhei36pt4bBitmaps, g_sSimhei36pt4b.bitmap, g_sSimhei36pt4b.bitmap_size);
    ...
    nema_bind_font(&g_sSimhei36pt8b);
    char *psram_simhei36pt8bBitmaps = psram_heap_malloc(g_sSimhei36pt8b.bitmap_size);
    nema_memcpy(psram_simhei36pt8bBitmaps, g_sSimhei36pt8b.bitmap, g_sSimhei36pt8b.bitmap_size);
    ...
    nema_cl_destroy(&sCL);
    psram_heap_free(psram_simhei36pt1bBitmaps);
    psram_heap_free(psram_simhei36pt4bBitmaps);
    psram_heap_free(psram_simhei36pt8bBitmaps);
    release_font_objects();
}
...
fb_reload_tsc4(void)
{
    g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_FB, RESX * RESY / 2);
    g_sFB.w = RESX;
    g_sFB.h = RESY;
    g_sFB.stride = RESX * 2;
    g_sFB.color = 0;
...
fb_reload_tsc6(void)
{
    g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_FB, RESX * RESY * 4 / 3);
    g_sFB.w = RESX;
    g_sFB.h = RESY;
    g_sFB.stride = RESX * 3;
    g_sFB.color = 0;
...
fb_reload_tsc6_new_size(uint16_t w, uint16_t h)
{
    ...
    g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_FB, align16(g_sFB.bo.size));
...
{
    g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_FB, RESX * RESY * 3);
    g_sFB.w = RESX;
    g_sFB.h = RESY;
    g_sFB.stride = RESX * 3;
    g_sFB.color = 0;
...
nema_psram_buffer_create(int32_t size)
{
    ...
    nema_buffer_t bo;
    bo.base_virt = psram_heap_malloc((size_t)size);
...
{
    g_sFB.bo = nema_buffer_create_pool(NEMA_MEM_POOL_FB, RESX * RESY * 4);
    if ( g_sFB.bo.base_phys == 0 )
    {
        while(1);
    }
...
blit_texture_psram(void)
{
    ...
    char *psram_greek_islend_100x100_alpha_rgba = psram_heap_malloc(sizeof(g_ui8GreekIsland100x100RGBA));
    nema_memcpy(psram_greek_islend_100x100_alpha_rgba, g_ui8GreekIsland100x100RGBA, sizeof(g_ui8GreekIsland100x100RGBA));
...
//!< nema_set_const_color(YELLOW);
    ...
    char *psram_greek_islend_100x100_rgba565 = psram_heap_malloc(sizeof(g_ui8GreekIsland100x100RGBA565));
    nema_memcpy(psram_greek_islend_100x100_rgba565, g_ui8GreekIsland100x100RGBA565, sizeof(g_ui8GreekIsland100x100RGBA565));
    ...
    char *psram_greek_islend_100x100_tsc6 = psram_heap_malloc(sizeof(g_ui8GreekIsland100x100TSC6));
    nema_memcpy(psram_greek_islend_100x100_tsc6, g_ui8GreekIsland100x100TSC6, sizeof(g_ui8GreekIsland100x100TSC6));
    ...
    char *psram_greek_islend_100x100_tsc4 = psram_heap_malloc(sizeof(g_ui8GreekIsland100x100TSC4));
    nema_memcpy(psram_greek_islend_100x100_tsc4, g_ui8GreekIsland100x100TSC4, sizeof(g_ui8GreekIsland100x100TSC4));
    ...
    char *psram_greek_islend_100x100_tsc6a = psram_heap_malloc(sizeof(g_ui8GreekIsland100x100TSC6A));
    nema_memcpy(psram_greek_islend_100x100_tsc6a, g_ui8GreekIsland100x100TSC6A, sizeof(g_ui8GreekIsland100x100TSC6A));
    ...
    char *psram_fz250_99x99_rgba8888 = psram_heap_malloc(sizeof(g_ui8FZ25099x99RGBA));
    nema_memcpy(psram_fz250_99x99_rgba8888, g_ui8FZ25099x99RGBA, sizeof(g_ui8FZ25099x99RGBA));
    ...
    psram_heap_free((void*)g_sGreekIslandRGBA8888.bo.base_phys);
    psram_heap_free((void*)g_sGreekIslandRGBA5650.bo.base_phys);
    psram_heap_free((void*)g_sGreekIslandTSC6.bo.base_phys);
    psram_heap_free((void*)g_sGreekIslandTSC4.bo.base_phys);
    psram_heap_free((void*)g_sGreekIslandTSC6A.bo.base_phys);
    psram_heap_free((void*)sFZ25099x99RGBA8888.bo.base_phys);
}
...
void
blit_texture_psram_390x390(void)
{
    img_obj_t obj_oli_390x390_alpha_rgba565 = {{0}, 390, 390, -1, 0, NEMA_RGB565, 0};
    nema_cmdlist_t sCL;
    ...
    char *psram_oli_390x390_alpha_rgba565 = psram_heap_malloc(sizeof(g_ui8Oli390x390RGBA565));
    nema_memcpy(psram_oli_390x390_alpha_rgba565, g_ui8Oli390x390RGBA565, sizeof(g_ui8Oli390x390RGBA565));
    obj_oli_390x390_alpha_rgba565.bo.base_phys = (uintptr_t)psram_oli_390x390_alpha_rgba565;
    obj_oli_390x390_alpha_rgba565.bo.base_virt = (void*)obj_oli_390x390_alpha_rgba565.bo.base_phys;
    nema_bind_src_tex(obj_oli_390x390_alpha_rgba565.bo.base_phys,
                      obj_oli_390x390_alpha_rgba565.w,
                      obj_oli_390x390_alpha_rgba565.h,
                      obj_oli_390x390_alpha_rgba565.format,
...
//!< nema_set_const_color(YELLOW);
    ...
    end_time = nema_get_time();
    am_util_stdio_printf("blit_texture_psram_390x390 rgba565 used %f s\n", end_time - start_time);
    ...
    psram_heap_free((void*)obj_oli_390x390_alpha_rgba565.bo.base_phys);
}
...
//    img_obj_t hour_tsc6a = {{0}, 20, 250, -1, 0, NEMA_TSC6A, 0};
    ...
    char *psram_hour_rgba8888 = psram_heap_malloc(sizeof(g_ui8Hour20x250RGBA));
    nema_memcpy(psram_hour_rgba8888, g_ui8Hour20x250RGBA, sizeof(g_ui8Hour20x250RGBA));
...
//!< img_obj_t hour_tsc6a = {{0}, 20, 250, -1, 0, NEMA_TSC6A, 0};
    ...
    char *psram_hour_tsc6 = psram_heap_malloc(sizeof(g_ui8Hour20x250TSC6));
    nema_memcpy(psram_hour_tsc6, g_ui8Hour20x250TSC6, sizeof(g_ui8Hour20x250TSC6));
    ...
    psram_heap_free((void*)hour_tsc6.bo.base_phys);
}
...
//!< img_obj_t hour_tsc6a = {{0}, 20, 250, -1, 0, NEMA_TSC6A, 0};
    ...
    char *psram_hour_tsc6a = psram_heap_malloc(sizeof(g_ui8Hour20x250TSC6A));
    nema_memcpy(psram_hour_tsc6a, g_ui8Hour20x250TSC6A, sizeof(g_ui8Hour20x250TSC6A));
    ...
    psram_heap_free((void*)hour_tsc6a.bo.base_phys);
}
...
//!< fb_reload_tsc6_new_size(180, 60);
    ...
    {
        nemadc_timing(fb_size_x, 1, 10, 1,
                    fb_size_y, 1, 1, 1);
    }
    else
    {
        nemadc_timing(fb_size_x, 1, 1, 1,
                    fb_size_y, 1, 1, 1);
    }
...
blit()
{
    //psram_heap_init((void *)MSPI_XIPMM_BASE_ADDRESS, 4*1024*1024UL, 10*1024UL);
    psram_heap_init(MSPI_XIPMM_BASE_ADDRESS, 4*1024*1024UL, 10*1024UL);
...
main(void)
{
    ...
    //
    uint32_t ui32Status = am_devices_mspi_psram_aps25616n_ddr_init(MSPI_PSRAM_MODULE, &MSPI_PSRAM_OctalCE1MSPIConfig, &g_pPSRAMHandle, &g_pMSPIHandle);
    ...
    //Set up display
    ui32Status = display_setup(RESX, RESY);
    if ( ui32Status != 0 )
    {
