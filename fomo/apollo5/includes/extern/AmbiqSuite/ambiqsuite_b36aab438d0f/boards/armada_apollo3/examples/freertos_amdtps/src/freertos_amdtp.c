...
#define WATCH_REGn(module, instance, reg)                                     \
    __attribute__((used)) volatile uint32_t *module##instance##_##reg =       \
        (uint32_t *) AM_REGADDRn(module, instance, reg)

//WATCH_REGn(BLEIF, 0, BSTATUS);  // BLEIF0_BSTATUS
//WATCH_REGn(BLEIF, 0, INTSTAT);  // BLEIF0_BSTATUS
