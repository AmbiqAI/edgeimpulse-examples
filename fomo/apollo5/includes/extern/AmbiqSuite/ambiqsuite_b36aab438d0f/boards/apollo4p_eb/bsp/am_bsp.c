...
void am_bsp_disp1_iom_enable( void )
{
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_CS, g_AM_BSP_GPIO_DISP1_IOM_CS ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_SCK, g_AM_BSP_GPIO_DISP1_IOM_SCK ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_MOSI, g_AM_BSP_GPIO_DISP1_IOM_MOSI ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_MISO, g_AM_BSP_GPIO_DISP1_IOM_MISO ) ;
}
void am_bsp_disp1_iom_disable( void )
{
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_CS, am_hal_gpio_pincfg_disabled ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_SCK, am_hal_gpio_pincfg_disabled ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_MOSI, am_hal_gpio_pincfg_disabled ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP1_IOM_MISO, am_hal_gpio_pincfg_disabled ) ;
}
void am_bsp_disp2_iom_enable( void )
{
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_CS, g_AM_BSP_GPIO_DISP2_IOM_CS ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_SCK, g_AM_BSP_GPIO_DISP2_IOM_SCK ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_MOSI, g_AM_BSP_GPIO_DISP2_IOM_MOSI ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_MISO, g_AM_BSP_GPIO_DISP2_IOM_MISO ) ;
}
void am_bsp_disp2_iom_disable( void )
{
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_CS, am_hal_gpio_pincfg_disabled ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_SCK, am_hal_gpio_pincfg_disabled ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_MOSI, am_hal_gpio_pincfg_disabled ) ;
    am_hal_gpio_pinconfig( AM_BSP_GPIO_DISP2_IOM_MISO, am_hal_gpio_pincfg_disabled ) ;
}
        ...
        case 0:
            ...
            switch (eMSPIDevice)
            {
...
#if defined(AM_BSP_QSPI_EC)
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_QSPI_EC_CE0, g_AM_BSP_GPIO_MSPI0_QSPI_EC_CE0);
#else
...
#if defined(AM_BSP_QSPI_EC)
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_QSPI_EC_CE1, g_AM_BSP_GPIO_MSPI0_QSPI_EC_CE1);
#else
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_CE1, g_AM_BSP_GPIO_MSPI0_CE1);
#endif
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D0,  g_AM_BSP_GPIO_MSPI0_D0);
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    ...
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D7,  g_AM_BSP_GPIO_MSPI0_D7);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_SCK, g_AM_BSP_GPIO_MSPI0_SCK);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_DQS, g_AM_BSP_GPIO_MSPI0_DQS);
                    break;
        ...
        case 1:
            ...
            switch (eMSPIDevice)
            {
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    ...
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D7,  g_AM_BSP_GPIO_MSPI1_D7);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_SCK, g_AM_BSP_GPIO_MSPI1_SCK);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_DQS, g_AM_BSP_GPIO_MSPI1_DQS);
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE1:
...
am_bsp_mspi_clkond4_pins_enable(uint32_t ui32Module, am_hal_mspi_device_e eMSPIDevice)
{
    ...
    {
        case 0:
#if defined(AM_BSP_GPIO_MSPI0_D4_SCK)
            switch ( eMSPIDevice )
            {
                case AM_HAL_MSPI_FLASH_SERIAL_CE0:
#if defined(AM_BSP_QSPI_EC)
                    ...
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D0,  g_AM_BSP_GPIO_MSPI0_D0);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D1,  g_AM_BSP_GPIO_MSPI0_D1);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D4_SCK, g_AM_BSP_GPIO_MSPI0_D4_SCK);
                    break;
                case AM_HAL_MSPI_FLASH_SERIAL_CE1:
                    break;
                case AM_HAL_MSPI_FLASH_QUAD_CE0:
        ...
        break;
#endif /* AM_BSP_GPIO_MSPI0_D4_SCK */
    case 1:
#if defined(AM_BSP_GPIO_MSPI1_D4_SCK)
        switch ( eMSPIDevice )
        {
            case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_CE0, g_AM_BSP_GPIO_MSPI1_CE0);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D0,  g_AM_BSP_GPIO_MSPI1_D0);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D1,  g_AM_BSP_GPIO_MSPI1_D1);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D4_SCK, g_AM_BSP_GPIO_MSPI1_D4_SCK);
                break;
            case AM_HAL_MSPI_FLASH_QUAD_CE0:
            case AM_HAL_MSPI_FLASH_QUAD_CE0_1_1_4:
            case AM_HAL_MSPI_FLASH_QUAD_CE0_1_4_4:
...
//                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D4_SCK, g_AM_BSP_GPIO_MSPI1_D4_SCK);
        ...
        break;
#endif /* AM_BSP_GPIO_MSPI1_D4_SCK */
    case 2:
#if defined(AM_BSP_GPIO_MSPI2_D4_SCK)
        switch ( eMSPIDevice )
        {
            case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_CE0, g_AM_BSP_GPIO_MSPI2_CE0);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_D0,  g_AM_BSP_GPIO_MSPI2_D0);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_D1,  g_AM_BSP_GPIO_MSPI2_D1);
                am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI2_D4_SCK, g_AM_BSP_GPIO_MSPI2_D4_SCK);
                break;
            case AM_HAL_MSPI_FLASH_SERIAL_CE1:
                break;
            case AM_HAL_MSPI_FLASH_QUAD_CE0:
        ...
        break;
#endif /* AM_BSP_GPIO_MSPI2_D4_SCK */
    default:
        break;
    }
    ...
    switch (ui32Module)
    {
        case 0:
            ...
            switch (eMSPIDevice)
            {
                case AM_HAL_MSPI_FLASH_SERIAL_CE0:
#if defined(AM_BSP_QSPI_EC)
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_QSPI_EC_CE0, am_hal_gpio_pincfg_disabled);
#else
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    ...
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D7,  am_hal_gpio_pincfg_disabled);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_SCK, am_hal_gpio_pincfg_disabled);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_DQS, am_hal_gpio_pincfg_disabled);
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE1:
        ...
        case 1:
            ...
            switch (eMSPIDevice)
            {
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    ...
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D7,  am_hal_gpio_pincfg_disabled);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_SCK, am_hal_gpio_pincfg_disabled);
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_DQS, am_hal_gpio_pincfg_disabled);
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE1:
...
{
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_ALS_SCL, g_AM_BSP_GPIO_DISP_TOUCH_ALS_SCL) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_ALS_SDA, g_AM_BSP_GPIO_DISP_TOUCH_ALS_SDA) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_INT, g_AM_BSP_GPIO_DISP_TOUCH_INT) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_ALS_INT, g_AM_BSP_GPIO_DISP_ALS_INT) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_RST, g_AM_BSP_GPIO_DISP_TOUCH_RST) ;
...
{
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_ALS_SCL, am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_ALS_SDA, am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_INT, am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_ALS_INT, am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_TOUCH_RST, am_hal_gpio_pincfg_disabled) ;
...
am_bsp_qdisp_enable( void )
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_D3,  g_AM_BSP_GPIO_DISP_QSPI_D3) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_SCK, g_AM_BSP_GPIO_DISP_QSPI_SCK) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_RST, g_AM_BSP_GPIO_DISP_QSPI_RST) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_TE,  g_AM_BSP_GPIO_DISP_QSPI_TE) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_SDO_SDI,  g_AM_BSP_GPIO_DISP_SDO_SDI) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_VCI_EN,        g_AM_BSP_GPIO_VCI_EN) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_IFSEL1,   g_AM_BSP_GPIO_DISP_IFSEL1) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_IFSEL2,   g_AM_BSP_GPIO_DISP_IFSEL2) ;
...
am_bsp_qdisp_disble( void )
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_D3,  am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_SCK, am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_RST, am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_QSPI_TE,  am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_SDO_SDI,  am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_VCI_EN,        am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_IFSEL1,   am_hal_gpio_pincfg_disabled) ;
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_IFSEL2,   am_hal_gpio_pincfg_disabled) ;
    ...
    switch (ui32Module)
    {
        ...
        case 0:
            ...
            switch (eMSPIDevice)
            {
                ...
                case AM_HAL_MSPI_FLASH_QUAD_CE0_1_4_4:
#if defined(AM_BSP_QSPI_EC)
                    *pPinnum = AM_BSP_GPIO_MSPI0_QSPI_EC_CE0;
                    *pPincfg = g_AM_BSP_GPIO_MSPI0_QSPI_EC_CE0;
#else
            ...
            switch (eMSPIDevice)
            {
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_CE0:
                    ...
                    *pPincfg = g_AM_BSP_GPIO_MSPI2_CE0;
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    *pPinnum = AM_BSP_GPIO_MSPI2_DDR_CE0;
                    *pPincfg = g_AM_BSP_GPIO_MSPI2_DDR_CE0;
                    break;
                default:
                    break;
            }
