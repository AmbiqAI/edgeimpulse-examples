...
extern void am_bsp_uart_printf_enable(void *pvHandle);
extern void am_bsp_uart_printf_disable(void);

extern void am_bsp_buffered_uart_printf_enable(void *pvHandle);
...
extern void am_bsp_disp_dpi_pins_enable(void);
#ifdef __cplusplus
}
#endif
