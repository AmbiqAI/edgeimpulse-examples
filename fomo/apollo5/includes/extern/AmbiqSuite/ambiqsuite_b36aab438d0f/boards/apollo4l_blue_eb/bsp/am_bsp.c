...
//! @addtogroup apollo4l_blue_eb BSP
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
//
//*****************************************************************************
const am_bsp_nor_flash_t bsp_nor_flash_devices[] =
{
    {
        .ui32Designator = AM_BSP_MSPI_NOR_FLASH_U7_DESIGNATOR,
        .ui32Module = AM_BSP_MSPI_NOR_FLASH_U7_MODULE,
    },
};
...
am_bsp_disp_pins_enable(void)
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_MSPI1_DEVICE_RST, g_AM_BSP_GPIO_DISP_MSPI1_DEVICE_RST);

    if ( g_sDispCfg.bClockonD4 == true )
    {
        am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D4_CLK, g_AM_BSP_GPIO_MSPI1_D4_CLK);
    }
    else
    {
        am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_SCK, g_AM_BSP_GPIO_MSPI1_SCK);
    }
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_TE,  g_AM_BSP_GPIO_MSPI1_TE);
   ...
   am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_MSPI2_DEVICE_RST, g_AM_BSP_GPIO_DISP_MSPI2_DEVICE_RST);
...
am_bsp_disp_pins_disable(void)
{
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_MSPI1_DEVICE_RST, am_hal_gpio_pincfg_disabled);

    if ( g_sDispCfg.bClockonD4 == true )
    {
        am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_D4_CLK, am_hal_gpio_pincfg_disabled);
    }
    else
    {
        am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_SCK, am_hal_gpio_pincfg_disabled);
    }
    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI1_TE,  am_hal_gpio_pincfg_disabled);
    ...
    am_hal_gpio_pinconfig(AM_BSP_GPIO_DISP_MSPI2_DEVICE_RST, am_hal_gpio_pincfg_disabled);
...
#if (DISPLAY_MSPI_INST == 1)
    am_hal_gpio_state_write(AM_BSP_GPIO_DISP_MSPI1_DEVICE_RST, eGpioWrType);
#elif (DISPLAY_MSPI_INST == 2)
    am_hal_gpio_state_write(AM_BSP_GPIO_DISP_MSPI2_DEVICE_RST, eGpioWrType);

#endif
//
// apollo4l_eb have no DISP_RST pin.
//
...
am_bsp_mspi_clkond4_pins_enable(uint32_t ui32Module, am_hal_mspi_device_e eMSPIDevice)
{
    switch (ui32Module)
    {
        case 0:
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                    ...
                    //
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D4_CLK, g_AM_BSP_GPIO_MSPI0_D4_CLK);
                    break;
        ...
        break;
#endif /* AM_BSP_GPIO_MSPI0_D4_CLK */
    case 1:
#if (AM_BSP_GPIO_MSPI1_D4_CLK)
        switch ( eMSPIDevice )
        {
            case AM_HAL_MSPI_FLASH_QUAD_CE0:
            case AM_HAL_MSPI_FLASH_QUAD_CE0_1_1_4:
        ...
        break;
#endif /* AM_BSP_GPIO_MSPI1_D4_CLK */
    case 2:
        ...
        case 0:
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_SERIAL_CE0:
                    ...
                    // setting clock on data pin 4.
                    //
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D4_CLK, am_hal_gpio_pincfg_disabled);
                    break;
