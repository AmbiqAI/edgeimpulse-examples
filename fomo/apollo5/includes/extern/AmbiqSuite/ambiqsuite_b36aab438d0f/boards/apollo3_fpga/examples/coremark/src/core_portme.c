...
// #### INTERNAL BEGIN ####
    ...
    //
    // ToDo: Check whether these are power-up defaults!

    //
    // Powerdown the BOD and PDR logic
    //
    AM_REG(MCUCTRLPRIV, BODPORCTRL) = 0x3;  // 3=disable both 2=disable BOD 1=disable PDR
// #### INTERNAL END ####
    //
    ...
    // Initialize for low power in the power control block
    //
    if ( am_hal_pwrctrl_low_power_init() )
    {
        while(1);
    }
