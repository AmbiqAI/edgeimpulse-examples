...
//!
//! @addtogroup apollo4l_blue_kbr_eb BSP for the Apollo4l blue kbr EB
//! @ingroup BSP
//! @{
//
//*****************************************************************************
...
{
#if (DISP_CTRL_IP == DISP_CTRL_IP_MSPI)
#warning "please connect IM1 to GND, IM2 and VCI_EN to VDD"
    ...
    // Set RES pin high
    //
    am_hal_gpio_output_set(AM_BSP_GPIO_DISP_RST);
#endif
}
        ...
        case 0:
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_SERIAL_CE1:
                    ...
                    // setting clock on data pin 4.
                    //
                    am_hal_gpio_pinconfig(AM_BSP_GPIO_MSPI0_D4_CLK, g_AM_BSP_GPIO_MSPI1_D4_CLK);
                    break;
                default:
                    break;
            }
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_CE1:
                    ...
                    *pPincfg = g_AM_BSP_GPIO_MSPI0_CE1;
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    *pPinnum = AM_BSP_GPIO_MSPI0_DDR_CE0;
                    *pPincfg = g_AM_BSP_GPIO_MSPI0_DDR_CE0;
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE1:
                    *pPinnum = AM_BSP_GPIO_MSPI0_DDR_CE1;
                    *pPincfg = g_AM_BSP_GPIO_MSPI0_DDR_CE1;
                    break;
                default:
                    break;
            }
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_CE1:
                    ...
                    *pPincfg = g_AM_BSP_GPIO_MSPI1_CE1;
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    *pPinnum = AM_BSP_GPIO_MSPI1_DDR_CE0;
                    *pPincfg = g_AM_BSP_GPIO_MSPI1_DDR_CE00;
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE1:
                    *pPinnum = AM_BSP_GPIO_MSPI1_DDR_CE1;
                    *pPincfg = g_AM_BSP_GPIO_MSPI1_DDR_CE1;
                    break;
                default:
                    break;
            }
            ...
            switch ( eMSPIDevice )
            {
                ...
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE0:
                    ...
                    *pPincfg = g_AM_BSP_GPIO_MSPI2_DDR_CE0;
                    break;
                case AM_HAL_MSPI_FLASH_OCTAL_DDR_CE1:
                    *pPinnum = AM_BSP_GPIO_MSPI2_DDR_CE1;
                    *pPincfg = g_AM_BSP_GPIO_MSPI2_DDR_CE1;
                    break;
                default:
                    break;
            }
