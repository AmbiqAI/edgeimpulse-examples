//*****************************************************************************
//
//! @file pixart_pah8001.h
//
//*****************************************************************************
#ifndef PIXART_PAH8001_H
#define PIXART_PAH8001_H
...
#define PAH8001_MODE_SPI                  true
#define PAH8001_MODE_I2C                  false
...
extern void pixart_accel_set(int16_t x, int16_t y, int16_t z);

extern void pah8001_low_power_enable(void);
extern void pah8001_low_power_disable(void);
...
//---------------------------------------PAH8001 functions----------------------
extern bool pah8001_init(void);
extern uint8_t pah8001_task(void);
