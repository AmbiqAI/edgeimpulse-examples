...
#include "../../libmetal/lib/alloc.h"
#include "../../libmetal/lib/cache.h"
#include "../../libmetal/lib/sleep.h"
...
/* Total tick count for 100ms - 1usec tick. */
#define RPMSG_TICK_COUNT                        (100000u)
