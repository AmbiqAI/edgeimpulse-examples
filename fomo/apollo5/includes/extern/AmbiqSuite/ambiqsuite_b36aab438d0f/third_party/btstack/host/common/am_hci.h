...
struct hci_config_data_path_cmd
{
    ...
    uint8_t vendor_specific_cfg[1/*__ARRAY_EMPTY*/];
};
...
struct hci_rd_local_supp_codec_cap_cmd_cmp_evt
{
    ...
    /// Codec Capability [i]
    uint8_t codec_cap[1/*__ARRAY_EMPTY*/]; // TODO: update when the number of codecs is available
};
...
struct hci_rd_local_supp_ctrl_delay_cmd
{
    ...
    /// Codec Configuration
    uint8_t codec_cfg[1/*__ARRAY_EMPTY*/];
};
