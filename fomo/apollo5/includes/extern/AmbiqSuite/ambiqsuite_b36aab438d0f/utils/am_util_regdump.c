...
// #### INTERNAL BEGIN ####
am_util_regdump_t g_sRegdumpFlash[] =
{
    {0x000, "STATUS"},
    {0x004, "WRADDR"},
    {0x008, "WRDATA"},
...
// #### INTERNAL BEGIN ####
    ...
    if ( ui32PeriphMask & AM_UTIL_REGDUMP_FLASH )
    {
        dump_reg(AM_REG_FLASHCTRL_NUM_MODULES, AM_REG_FLASHCTRLn(0),
                 AM_REG_FLASHCTRLn(1) - AM_REG_FLASHCTRLn(0),
                 ui32ModuleMask, "Flash Controller", &g_sRegdumpFlash[0]);
    }
// #### INTERNAL END ####
