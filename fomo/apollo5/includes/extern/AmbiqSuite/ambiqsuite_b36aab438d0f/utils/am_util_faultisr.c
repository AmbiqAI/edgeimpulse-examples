...
// #### INTERNAL BEGIN ####
#elif defined(AM_PART_BRONCO)   // same as defines as Apollo4p
  #define AM_SP_LOW    SRAM_BASEADDR
  #define AM_SP_HIGH   (SRAM_BASEADDR + RAM_TOTAL_SIZE)
// #### INTERNAL END ####
#endif
...
#if !defined(AM_PART_APOLLO5A) && !defined(AM_PART_APOLLO5B) && !defined(AM_PART_APOLLO510L) // No CPU register block in Apollo5
    //
...
#endif  // !defined(AM_PART_APOLLO5A) && !defined(AM_PART_APOLLO5B) || defined(AM_PART_APOLLO510L)
