...
//
//*****************************************************************************
#if defined(AM_PART_APOLLO3) || defined(AM_PART_APOLLO3P) || defined(AM_PART_APOLLO4_API)|| defined(AM_PART_APOLLO5_API)
void
unity_output_init(void)
{
...
#else // NOT (AM_PART_APOLLO3) || (AM_PART_APOLLO3P) || (AM_PART_APOLLO4) || (AM_PART_APOLLO4B) || (AM_PART_APOLLO4P)  || (AM_PART_APOLLO4L)
...
//*****************************************************************************
void
unity_output_end(void)
{
    //
    // End with an "end of transmission" character before we shut off the ITM.
    //
#if 1
#if defined(AM_PART_APOLLO4) || defined(AM_PART_APOLLO4B) || defined(AM_PART_APOLLO4P) || defined(AM_PART_APOLLO4L) || defined(AM_PART_BRONCO) || defined(AM_PART_APOLLO5A) || defined(AM_PART_APOLLO5B)
