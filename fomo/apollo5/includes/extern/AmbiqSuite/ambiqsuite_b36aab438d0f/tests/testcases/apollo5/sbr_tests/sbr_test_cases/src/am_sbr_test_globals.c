...
const debug_words_t expected_sbr_debug_words[5][4] = {
     {   // CM Vanilla (Security word not written)
         {{0x00000000,       BR_STATUS_CKPT9, 0x0200816F, 0x020000D5}},  // CM
...
const dcu_bits_t expected_dcu_lock_bits[5][4] = {
     ...
     {   // AmbSBL-nonsecure mode
         {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // CM
         {{0xFFFF8E3F, 0x8FFFFFFF, 0x00000000, 0x00000000}},  // DM
         {{0xFFFF8E3F, 0x8FFFFFFF, 0x00000000, 0x00000000}},  // Sec
         {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // RMA
     },
     {   // AmbSBL-secure mode
         {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // CM
         {{0xFFFF8FFF, 0x8FFFFFFF, 0x00000000, 0x00000000}},  // DM
         {{0xFFFF8E3F, 0x8FFFFFFF, 0x00000000, 0x00000000}},  // Sec
         {{0x00000000, 0x00000000, 0x00000000, 0x00000000}},  // RMA
     },
     {   // nonSBL-nonsecure mode
...
const dcu_bits_t expected_dcu_enable_bits[5][4] = {
     ...
     {   // AmbSBL-nonsecure mode
         {{0x6DB6DB68, 0x5B6DB6DB, 0x6DB6DB6D, 0x5B6DB6DB}},  // CM
         {{0x00005140, 0x00000000, 0x68B6DB6D, 0x5B6DB6DB}},  // DM
         {{0x00005140, 0x00000000, 0x00000A28, 0x00000000}},  // Sec
         {{0x68B6DB68, 0x5B6DB6DB, 0x68B6DB6D, 0x5B6DB6DB}},  // RMA
     },
     {   // AmbSBL-secure mode
         {{0x6DB6DB68, 0x5B6DB6DB, 0x6DB6DB6D, 0x5B6DB6DB}},  // CM
         {{0x00005140, 0x00000000, 0x68B6DB6D, 0x5B6DB6DB}},  // DM
     ...
     {   // nonSBL-nonsecure mode
         {{0x6DB6DB68, 0x5B6DB6DB, 0x6DB6DB6D, 0x5B6DB6DB}},  // CM
         {{0x00000000, 0x00000000, 0x68B6DB6D, 0x5B6DB6DB}},  // DM
         {{0x00000000, 0x00000000, 0x00000A28, 0x00000000}},  // Sec
         {{0x68B6DB68, 0x5B6DB6DB, 0x68B6DB6D, 0x5B6DB6DB}},  // RMA
     },
     {   // nonSBL-secure mode
         {{0x6DB6DB68, 0x5B6DB6DB, 0x6DB6DB6D, 0x5B6DB6DB}},  // CM
