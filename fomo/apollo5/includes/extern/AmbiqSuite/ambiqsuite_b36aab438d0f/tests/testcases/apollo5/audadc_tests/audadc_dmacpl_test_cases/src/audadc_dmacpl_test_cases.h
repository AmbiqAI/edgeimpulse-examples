...
#define CH_B0_EN               1  // enable LPADC23 inputs with PGA channel B0 on AUDADC SLOT2
#define CH_B1_EN               1  // enable LPADC23 inputs with PGA channel B1 on AUDADC SLOT3
...
#define CH_B0_GAIN_DB       0.0  // PGA channel B0 gain in dB (valid range: -6.0 to 36.0)
#define CH_B1_GAIN_DB       0.0  // PGA channel B1 gain in dB (valid range: -6.0 to 36.0)
