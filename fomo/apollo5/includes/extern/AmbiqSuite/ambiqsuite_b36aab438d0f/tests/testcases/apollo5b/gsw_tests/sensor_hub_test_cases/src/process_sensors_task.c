...
uint8_t g_pui8RcvBuf[AM_TEST_RCV_BUF_SIZE] __attribute__((aligned(32)));
uint8_t g_pui8SensorDataBuf[2][MSG_BUF_BYTES] __attribute__((aligned(32))); // ping pong buffer for data to send to eMMC task
