...
//! SPI:
//!     HOST (ios_lram_host - Apollo3)          SLAVE (ios_lram - Apollo5)
//!     --------------------                    ----------------
...
globalSetUp(void)
{
    ...
    am_util_stdio_printf("0 to 5  :   IOS SPI SCK             to  IOM0 SPI SCK\n");
    am_util_stdio_printf("1 to 6  :   IOS SPI MOSI            to  IOM0 SPI MOSI\n");
    am_util_stdio_printf("2 to 7  :   IOS SPI MISO            to  IOM0 SPI MOSI\n");
    am_util_stdio_printf("3 to 60 :   IOS SPI nCE             to  IOM0 SPI nCE\n");
    am_util_stdio_printf("8 to 42 :   Host Send Request                       \n");
    am_util_stdio_printf("9 to 43 :   Slave Ack Request                       \n\n");
    am_util_stdio_printf("I2C:\n\n");
    am_util_stdio_printf("Pins    :   IOS                         IOM0\n");
    am_util_stdio_printf("0 to 5  :   IOS I2C SCL             to  IOM0 I2C SCL\n");
    am_util_stdio_printf("1 to 6  :   IOS I2C SDA             to  IOM0 I2C SDA\n");
    am_util_stdio_printf("4 to 10 :   IOS Interrupt           to  Handshake Interrupt\n");
}
