...
static TLS_VAR nemadc_layer_t dc_layer = {(void *)0, 0, (FB_RESX / 4) * 4, (FB_RESY / 4) * 4, -1, 0, 0, (FB_RESX / 4) * 4, (FB_RESY / 4) * 4, 0xff, NEMADC_BL_SRC, 0, NEMADC_RGB24, 0, 0, 0, 0, 0,0,0, 0};
#else
