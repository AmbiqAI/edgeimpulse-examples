...
{
    {{0},  FB_RESX, FB_RESY, -1, 1, FRAME_BUFFER_FORMAT, NEMA_FILTER_BL,},
    {{0},  FB_RESX, FB_RESY, -1, 1, FRAME_BUFFER_FORMAT, NEMA_FILTER_BL,},
};
...
#ifdef NEMA_GFX_POWERSAVE
    //Check GPU status and power down it if it is idle.
    NEMA_BUILDCL_END
                 ...
                 lv_color_t * color_p)
{
    ...
    GPU_memcpy(FB_RESX, FB_RESY, FRAME_BUFFER_FORMAT, des, src);
...
lv_disp_drv_setup(void)
{
    ...
    disp_drv.hor_res = FB_RESX;
    disp_drv.ver_res = FB_RESY;
