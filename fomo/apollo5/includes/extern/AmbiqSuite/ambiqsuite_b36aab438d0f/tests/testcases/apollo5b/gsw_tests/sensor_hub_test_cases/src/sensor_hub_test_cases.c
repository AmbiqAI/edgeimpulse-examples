...
void sensor_hub_test(void)
{
    ...
    am_hal_gpio_pinconfig(141, am_hal_gpio_pincfg_output);
    ...
    am_hal_gpio_state_write(136, AM_HAL_GPIO_OUTPUT_CLEAR);
    am_hal_gpio_state_write(141, AM_HAL_GPIO_OUTPUT_CLEAR);
