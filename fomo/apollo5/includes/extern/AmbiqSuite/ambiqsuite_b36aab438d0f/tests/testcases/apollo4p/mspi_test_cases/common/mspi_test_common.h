...
#include "am_mcu_apollo.h"
     ...
     defined(APS6404L) || defined(APS12808L) || defined(APS25616N) || defined(W958D6NW) || defined(MB85RS64V) || defined(AMBT53))
...
#define MSPI_TEST_PAGE_INCR     (AM_DEVICES_MSPI_FLASH_PAGE_SIZE*33)
#endif
...
#define END_SPEED_INDEX         3
#else
//
// This is only a small subset of the full list 0f 10 speeds
//
#define END_SPEED_INDEX         4
//#define END_SPEED_INDEX         10
#endif

#if defined(APOLLO4_FPGA)
#define MSPI_TEST_NUM_INSTANCES 1
#else
#define MSPI_TEST_NUM_INSTANCES 1
#endif
...
extern uint32_t    mspi_instances[];
