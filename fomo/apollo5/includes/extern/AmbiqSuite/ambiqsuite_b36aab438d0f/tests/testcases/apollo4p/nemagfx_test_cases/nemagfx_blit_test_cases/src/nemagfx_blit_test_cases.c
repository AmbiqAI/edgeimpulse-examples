...
uint32_t g_dc_checksum_table[3]  = { 0xd01c541e, 0xf8a05cc0, 0x65acee15};
...
nemagfx_blit_test(void)
{
    ...
    for(ui32SampleType = 0; ui32SampleType < 3; ui32SampleType++) // Removed MIRROR test
    {
        ...
        // The pixel data in RM69330 are compressed, we are not able to compare data written with the data read back.
