...
#ifndef AM_WIDGET_MCUCTRL_H
#define AM_WIDGET_MCUCTRL_H

typedef enum
{
    AM_WIDGET_SUCCESS,
    AM_WIDGET_ERROR
} am_widget_mcuctrl_status_t;
...
//    am_hal_mcuctrl_config_t   IOMConfig;
} am_widget_mcuctrl_config_t;
