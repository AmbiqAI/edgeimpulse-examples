...
AM_SHARED_RW uint32_t                   DMATCBBuffer[IOM_MODULE_TOTAL][1024];
...
volatile bool g_bIomDmaFinish[IOM_MODULE_TOTAL] = {true, true, true, true, true, true, true, true};
float g_IomStartTime[IOM_MODULE_TOTAL], g_IomStopTime[IOM_MODULE_TOTAL];
//*****************************************************************************
//
// IOM ISRs.
//
...
#if defined(AM_PART_APOLLO4B) || defined(AM_PART_APOLLO4P) || defined(AM_PART_APOLLO4L) || defined(AM_PART_BRONCO) || defined(AM_PART_APOLLO5A) || defined(AM_PART_APOLLO5B)
