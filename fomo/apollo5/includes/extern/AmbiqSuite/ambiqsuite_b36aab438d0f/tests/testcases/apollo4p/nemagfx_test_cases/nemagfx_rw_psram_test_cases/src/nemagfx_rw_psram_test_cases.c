...
nemagfx_rw_psram_test(void)
{
    ...
    // Init PSRAM device.
    //
    ui32Status = am_devices_mspi_psram_aps25616n_ddr_init(MSPI_TEST_MODULE, &MSPI_PSRAM_CE1MSPIConfig, &g_pDevHandle, &g_pHandle);
#ifndef APS25616N_OCTAL_MODE_EN
    ...
    g_bDMAFinish = false;
    am_devices_mspi_psram_aps25616n_ddr_nonblocking_read(g_pDevHandle,
