...
float g_SdioStartTime, g_SdioStopTime;
...
sdio_init()
{
    ...
    // Configure SDIO PINs.
    //
    am_bsp_sdio_pins_enable(0, AM_HAL_HOST_BUS_WIDTH_8);
    ...
    NVIC_SetPriority(SDIO0_IRQn, AM_IRQ_PRIORITY_DEFAULT);
    return true;
}
