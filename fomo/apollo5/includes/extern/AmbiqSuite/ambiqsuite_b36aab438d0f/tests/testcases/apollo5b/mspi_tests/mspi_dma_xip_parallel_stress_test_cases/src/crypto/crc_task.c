...
crc_task_init(void)
{
    ...
    ui32Ret = am_hal_info1_read(AM_HAL_INFO_INFOSPACE_CURRENT_INFO1, AM_REG_OTP_INFO1_SBR_SDCERT_ADDR_O / 4, 4, info1_ref);
    if ( (info1_ref[0] == 0x00000000)  ||
         (info1_ref[1] == 0x00000000)  ||
         (info1_ref[2] == 0x00000000)  ||
         (info1_ref[3] == 0x00000000)  ||
#ifdef AM_PART_APOLLO5A
         (info1_ref[0] == 0xFFFFFFFF)  ||
         (info1_ref[1] == 0xFFFFFFFF)  ||
         (info1_ref[2] == 0xFFFFFFFF)  ||
         (info1_ref[3] == 0xFFFFFFFF)  ||
#endif // AM_PART_APOLLO5A
         (ui32Ret != AM_HAL_STATUS_SUCCESS) )
    {
        // Set a default value
        info1_ref[0] = info1_ref[1] = info1_ref[2] = info1_ref[3] = 0x00000000;
        PRINT("Failed to read info1_ref data from INFO1.\n");
    }
...
crc_operation(void)
{
    ...
    if (!bCryptoInUse)
    {
        ...
        ui32Ret = am_hal_info1_read(AM_HAL_INFO_INFOSPACE_CURRENT_INFO1, AM_REG_OTP_INFO1_SBR_SDCERT_ADDR_O / 4, 4, dummy);
        if ( (dummy[0] == 0x00000000)  ||
             (dummy[1] == 0x00000000)  ||
             (dummy[2] == 0x00000000)  ||
             (dummy[3] == 0x00000000)  ||
#ifdef AM_PART_APOLLO5A
        ...
        {
            // Set a default value
            dummy[0] = dummy[1] = dummy[2] = dummy[3] = 0x00000000;
            while(1);
        }
