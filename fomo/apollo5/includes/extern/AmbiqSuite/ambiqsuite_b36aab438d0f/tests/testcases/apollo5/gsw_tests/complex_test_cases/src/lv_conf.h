...
#define LV_TICK_CUSTOM_INCLUDE  "complex_test_cases.h"         /*Header for the system time function*/
...
#  define LV_MEM_TCM_ADR (0x20080000UL - 64UL * 1024UL)   /*0: unused*/
...
#  define LV_MEM_PSRAM_SIZE GFX_MEM_LEN         /*[bytes]*/
/*Set an address for the PSRAM heap*/
//#  define LV_MEM_PSRAM_ADR (0x60000000UL)    /*0: unused*/
#  define LV_MEM_PSRAM_ADR GFX_MEM_ADDRESS    /*0: unused*/
