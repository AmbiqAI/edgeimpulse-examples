...
#if (defined(MICRON_N25Q256A) || defined(MACRONIX_MX25U12835F) || defined(ADESTO_ATXP032) || defined(CYPRESS_S25FS064S) || defined(DOSILICON_DS35X1GA) || \
     defined(TOSHIBA_TC58CYG0))
...
typedef struct
{
...
#if defined(DOSILICON_DS35X1GA) || defined(TOSHIBA_TC58CYG0)
    uint32_t (*mspi_init)(uint32_t ui32Module, const am_widget_mspi_devices_config_t *psMSPISettings, void **ppHandle, void **ppMspiHandle);
    ...
    uint32_t (*mspi_init_timing_check)(uint32_t ui32Module,
                                        const am_widget_mspi_devices_config_t *pDevCfg,
