...
#define ADC_TRIGGER_SW_TIMER            1
#define ADC_TRIGGER_TIMER_7_ADCEN       0
#define ADC_TRIGGER_RPTTRIG             0
...
//
// timer interrupt (temperary used because of the bug in am_hal_timer.h)
//
#define AM_HAL_TIMER_INT_TMR0_CMP0_WG    (_VAL2FLD(TIMER_INTSTAT_TMR00INT, 1))

#if ADC_TRIGGER_TIMER_7_ADCEN
#define AM_HAL_TIMER_INT_TMR7_CMP0_WG    (_VAL2FLD(TIMER_INTSTAT_TMR70INT, 1))
#endif
