...
am_widget_iom_test_nonblocking_write_read(void *pWidget, void *pCfg, char *pErrStr)
{
    ...
    ui32Status = iom_device_func.iom_device_nonblocking_write(g_IomDevHdl, &g_pucOutBuffer[0] + ui32Offset, 0, pTestCfg->ui32BufferSize, pfnWidget_IOM_Callback_Write, 0);
