...
#define am_widget_iom_devices_config_t       am_devices_mb85rs1mt_config_t
#elif MB85RQ4ML
...
#define am_widget_iom_devices_config_t       am_devices_mb85rq4ml_config_t
#elif MB85RS64V
...
#define am_widget_iom_devices_config_t       am_devices_mb85rs64v_config_t
#elif MB85RC256V
...
#define am_widget_iom_devices_config_t       am_devices_mb85rc256v_config_t
#elif MB85RC64TA
#define IOM_WIDGET_DEVICE_MODE        AM_WIDGET_IOM_I2C_DEVICE
...
#define am_widget_iom_devices_config_t       am_devices_spipsram_config_t
#elif EM9304
#include "am_devices_em9304.h"
#define IOM_WIDGET_DEVICE_MODE        AM_WIDGET_IOM_SPI_DEVICE
#define IOM_WIDGET_DEVICE_SUCCESS     AM_DEVICES_EM9304_STATUS_SUCCESS
#define am_widget_iom_devices_config_t       am_devices_em9304_config_t
#elif LOOP
#include "am_devices_em9304.h"
#define IOM_WIDGET_DEVICE_MODE        AM_WIDGET_IOM_SPI_DEVICE
#define IOM_WIDGET_DEVICE_SUCCESS     AM_DEVICES_LOOP_STATUS_SUCCESS
#define am_widget_iom_devices_config_t       am_devices_loop_config_t
#elif AMBT53_SCPM
#include "am_devices_ambt53.h"
#define IOM_WIDGET_DEVICE_MODE        AM_WIDGET_IOM_I2C_DEVICE
#define IOM_WIDGET_DEVICE_SUCCESS     AM_DEVICES_SCPM_STATUS_SUCCESS
#define am_widget_iom_devices_config_t       am_devices_scpm_config_t
#elif TSL2540
...
#define am_widget_iom_devices_config_t       am_hal_iom_config_t
#else
// No devices
// #define am_widget_iom_devices_config_t       am_devices_mb85rc256v_config_t
#error  ("no devices")
...
//#TODO remove the handshake pin definition form the widget
...
typedef enum
{
    ...
    AM_WIDGET_DEVICE_IOSLOOP        // IOS loopback
} am_widget_iom_device_type_t;

typedef struct
{
    uint32_t                            ui32Module;
    am_widget_iom_devices_config_t      IOMConfig;
    am_widget_iom_device_type_t         ui32DeviceType;
} am_widget_iom_config_t;

typedef struct
{
    uint32_t                      ui32NumBytes;     // Number of bytes to read/write.
    uint32_t                      ui32ByteOffset;   // byte offset in read/write buffer.
...
extern uint32_t am_devices_loop_init(uint32_t ui32Module, am_widget_iom_devices_config_t *pDevConfig,
                                     void **ppHandle, void **ppIomHandle);
extern uint32_t am_devices_loop_term(void *pHandle);


extern bool am_widget_iom_test_setup(am_widget_iom_config_t *pTestCfg,
                                         void **ppWidget, char *pErrStr);
extern uint32_t am_widget_fullduplex_spi_iom_setup(am_widget_iom_config_t *pTestCfg,
                                  void **ppWidget, char *pErrStr);
