//*****************************************************************************
//
//! @file am_widget_i2s.h
//!
//! @brief Test widget for testing I2S channels by data transfer.
//!
//
//*****************************************************************************
...
#ifndef AM_WIDGET_I2S_H
#define AM_WIDGET_I2S_H

#define AM_WIDGET_I2S_SUCCESS   AM_HAL_STATUS_SUCCESS
...
typedef struct i2s_loopback_test_settings
{
    ...
    am_hal_i2s_channel_length_e eFrameWordLenPh1;   // data width in bits for phase 1
    am_hal_i2s_channel_length_e eFrameWordLenPh2;   // data width in bits for phase 2
...
extern void am_widget_i2s_handler_deinitialize(void);
extern uint32_t am_widget_i2s_pin_enable(void);
extern uint32_t am_widget_i2s_build_configuration(uint32_t i2s_channel,
                                                  i2s_loopback_test_settings_t* test_setting,
                                                  am_hal_i2s_config_t* config);
extern uint32_t am_widget_i2s_build_asrc_configuration(uint32_t i2s_channel,
                                                       i2s_asrc_test_settings_t* test_setting,
                                                       am_hal_i2s_config_t* config);

extern bool am_widget_i2s_check_data(uint32_t ui32BufSize, \
                                     uint32_t* pui32RxBuf, \
                                     uint32_t* pui32TxBuf, \
                                     i2s_loopback_test_settings_t* pI2sSetting, \
                                     bool bRxIsMaster);
