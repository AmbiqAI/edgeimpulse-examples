...
//! SPI:
//! Pins    :   IOS                         IOM0
//! 0 to 5  :   IOS SPI SCK             to  IOM0 SPI SCK
//! 1 to 7  :   IOS SPI MOSI            to  IOM0 SPI MOSI
//! 2 to 6  :   IOS SPI MISO            to  IOM0 SPI MOSI
//! 3 to 11 :   IOS SPI nCE             to  IOM0 SPI nCE
//! 4 to 10 :   IOS Interrupt           to  Handshake Interrupt
//!
//! I2C:
//! 0 to 5  :   IOS I2C SCL             to  IOM0 I2C SCL
//! 1 to 6  :   IOS I2C SDA             to  IOM0 I2C SDA
//! 4 to 10 :   IOS Interrupt           to  Handshake Interrupt
//! @endverbatim
//
//*****************************************************************************
...
AM_SHARED_RW uint8_t g_pRefData[AM_IOS_TX_BUFSIZE_MAX];
AM_SHARED_RW uint8_t g_pIomRecvBuf[AM_IOS_TX_BUFSIZE_MAX];
...
ios_set_up(am_widget_iosspi_stimulus_ios_t *pCfg)
{
    ...
    // Set up the IOSINT interrupt pin
    //am_hal_gpio_pinconfig(HANDSHAKE_IOS_PIN, g_AM_BSP_GPIO_IOS_INT);
