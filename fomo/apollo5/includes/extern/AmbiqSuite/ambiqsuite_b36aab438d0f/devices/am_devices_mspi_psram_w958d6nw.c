...
// #### INTERNAL BEGIN ####
#if (defined(APOLLO4_FPGA) || defined(APOLLO5_FPGA) && !defined(USE_NEW_DDR))
#define W958D6NW_USE_NON_DQS_MODE
#else
// #### INTERNAL END ####
//#define W958D6NW_USE_NON_DQS_MODE
// #### INTERNAL BEGIN ####
#if defined (USE_NEW_DDR) && defined(W958D6NW_USE_NON_DQS_MODE)
#undef W958D6NW_USE_NON_DQS_MODE   // New DDR requires DQS enable
#endif
#endif //defined(APOLLO4_FPGA) || defined(APOLLO5_FPGA) && !defined(USE_NEW_DDR)
// #### INTERNAL END ####
...
// #### INTERNAL BEGIN ####
// CAYNSWS-1854 workaround new ddr big endian issue
// #### INTERNAL END ####
#if defined (USE_NEW_DDR) && defined(AM_PART_APOLLO5B)
  if ( ui32NumBytes < 4 )
  {
