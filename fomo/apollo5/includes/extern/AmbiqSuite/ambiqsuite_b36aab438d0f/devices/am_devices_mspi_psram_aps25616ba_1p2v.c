...
//*****************************************************************************
// #### INTERNAL BEGIN ####
#if defined (APOLLO5_FPGA) && !defined(USE_NEW_DDR)
#define USE_NON_DQS_MODE
#else
// #### INTERNAL END ####
//#define USE_NON_DQS_MODE
// #### INTERNAL BEGIN ####
#if defined (USE_NEW_DDR) && defined(USE_NON_DQS_MODE)
#undef USE_NON_DQS_MODE   // New DDR requires DQS enable
#endif
#endif //defined (APOLLO5_FPGA) && !defined(USE_NEW_DDR)
// #### INTERNAL END ####
